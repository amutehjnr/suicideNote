 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */(function(e){function t(x,z){var D=x.length;x.push(z);e:for(;0<D;){var G=D-1>>>1,V=x[G];if(0<o(V,z))x[G]=z,x[D]=V,D=G;else break e}}function n(x){return x.length===0?null:x[0]}function a(x){if(x.length===0)return null;var z=x[0],D=x.pop();if(D!==z){x[0]=D;e:for(var G=0,V=x.length,ge=V>>>1;G<ge;){var Ie=2*(G+1)-1,Ve=x[Ie],Be=Ie+1,F=x[Be];if(0>o(Ve,D))Be<V&&0>o(F,Ve)?(x[G]=F,x[Be]=D,G=Be):(x[G]=Ve,x[Ie]=D,G=Ie);else if(Be<V&&0>o(F,D))x[G]=F,x[Be]=D,G=Be;else break e}}return z}function o(x,z){var D=x.sortIndex-z.sortIndex;return D!==0?D:x.id-z.id}if(typeof performance=="object"&&typeof performance.now=="function"){var r=performance;e.unstable_now=function(){return r.now()}}else{var i=Date,l=i.now();e.unstable_now=function(){return i.now()-l}}var u=[],c=[],d=1,m=null,g=3,S=!1,y=!1,k=!1,E=typeof setTimeout=="function"?setTimeout:null,f=typeof clearTimeout=="function"?clearTimeout:null,h=typeof setImmediate<"u"?setImmediate:null;typeof navigator<"u"&&navigator.scheduling!==void 0&&navigator.scheduling.isInputPending!==void 0&&navigator.scheduling.isInputPending.bind(navigator.scheduling);function p(x){for(var z=n(c);z!==null;){if(z.callback===null)a(c);else if(z.startTime<=x)a(c),z.sortIndex=z.expirationTime,t(u,z);else break;z=n(c)}}function N(x){if(k=!1,p(x),!y)if(n(u)!==null)y=!0,ee(C);else{var z=n(c);z!==null&&ae(N,z.startTime-x)}}function C(x,z){y=!1,k&&(k=!1,f(B),B=-1),S=!0;var D=g;try{for(p(z),m=n(u);m!==null&&(!(m.expirationTime>z)||x&&!X());){var G=m.callback;if(typeof G=="function"){m.callback=null,g=m.priorityLevel;var V=G(m.expirationTime<=z);z=e.unstable_now(),typeof V=="function"?m.callback=V:m===n(u)&&a(u),p(z)}else a(u);m=n(u)}if(m!==null)var ge=!0;else{var Ie=n(c);Ie!==null&&ae(N,Ie.startTime-z),ge=!1}return ge}finally{m=null,g=D,S=!1}}var A=!1,P=null,B=-1,U=5,j=-1;function X(){return!(e.unstable_now()-j<U)}function Z(){if(P!==null){var x=e.unstable_now();j=x;var z=!0;try{z=P(!0,x)}finally{z?ne():(A=!1,P=null)}}else A=!1}var ne;if(typeof h=="function")ne=function(){h(Z)};else if(typeof MessageChannel<"u"){var we=new MessageChannel,R=we.port2;we.port1.onmessage=Z,ne=function(){R.postMessage(null)}}else ne=function(){E(Z,0)};function ee(x){P=x,A||(A=!0,ne())}function ae(x,z){B=E(function(){x(e.unstable_now())},z)}e.unstable_IdlePriority=5,e.unstable_ImmediatePriority=1,e.unstable_LowPriority=4,e.unstable_NormalPriority=3,e.unstable_Profiling=null,e.unstable_UserBlockingPriority=2,e.unstable_cancelCallback=function(x){x.callback=null},e.unstable_continueExecution=function(){y||S||(y=!0,ee(C))},e.unstable_forceFrameRate=function(x){0>x||125<x?console.error("forceFrameRate takes a positive int between 0 and 125, forcing frame rates higher than 125 fps is not supported"):U=0<x?Math.floor(1e3/x):5},e.unstable_getCurrentPriorityLevel=function(){return g},e.unstable_getFirstCallbackNode=function(){return n(u)},e.unstable_next=function(x){switch(g){case 1:case 2:case 3:var z=3;break;default:z=g}var D=g;g=z;try{return x()}finally{g=D}},e.unstable_pauseExecution=function(){},e.unstable_requestPaint=function(){},e.unstable_runWithPriority=function(x,z){switch(x){case 1:case 2:case 3:case 4:case 5:break;default:x=3}var D=g;g=x;try{return z()}finally{g=D}},e.unstable_scheduleCallback=function(x,z,D){var G=e.unstable_now();switch(typeof D=="object"&&D!==null?(D=D.delay,D=typeof D=="number"&&0<D?G+D:G):D=G,x){case 1:var V=-1;break;case 2:V=250;break;case 5:V=1073741823;break;case 4:V=1e4;break;default:V=5e3}return V=D+V,x={id:d++,callback:z,priorityLevel:x,startTime:D,expirationTime:V,sortIndex:-1},D>G?(x.sortIndex=D,t(c,x),n(u)===null&&x===n(c)&&(k?(f(B),B=-1):k=!0,ae(N,D-G))):(x.sortIndex=V,t(u,x),y||S||(y=!0,ee(C))),x},e.unstable_shouldYield=X,e.unstable_wrapCallback=function(x){var z=g;return function(){var D=g;g=z;try{return x.apply(this,arguments)}finally{g=D}}}})(Ec);bc.exports=Ec;var Am=bc.exports;/**
 * @license React
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Rg=e=>e.replace(/([a-z0-9])([A-Z])/g,"$1-$2").toLowerCase().trim(),Ce=(e,t)=>{const n=b.forwardRef(({color:a="currentColor",size:o=24,strokeWidth:r=2,absoluteStrokeWidth:i,className:l="",children:u,...c},d)=>b.createElement("svg",{ref:d,...Bg,width:o,height:o,stroke:a,strokeWidth:i?Number(r)*24/Number(o):r,className:["lucide",`lucide-${Rg(e)}`,l].join(" "),...c},[...t.map(([m,g])=>b.createElement(m,g)),...Array.isArray(u)?u:[u]]));return n.displayName=`${e}`,n};/**
 * @license lucide-react v0.309.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Mg=Ce("ArrowRight",[["path",{d:"M5 12h14",key:"1ays0h"}],["path",{d:"m12 5 7 7-7 7",key:"xquz4c"}]]);/**
 * @license lucide-react v0.309.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 ...
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const zg=Ce("Copy",[["rect",{width:"14",height:"14",x:"8",y:"8",rx:"2",ry:"2",key:"17jyea"}],["path",{d:"M4 16c-1.1 0-2-.9-2-2V4c0-1.1.9-2 2-2h10c1.1 0 2 .9 2 2",key:"zix9uf"}]]);/**
 * @license lucide-react v0.309.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
 */const Wg=Ce("DollarSign",[["line",{x1:"12",x2:"12",y1:"2",y2:"22",key:"7eqyqh"}],["path",{d:"M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6",key:"1b0p4s"}]]);/**
 * @license lucide-react v0.309.0 - ISC
 *
 * This source code is licensed under the ISC license.
 * See the LICENSE file in the root directory of this source tree.
...
`,rb=(e,t)=>{let n=e.includes("top")?1:-1,[a,o]=BI()?[tb,nb]:[ZI(n),eb(n)];return{animation:t?`${zt(a)} 0.35s cubic-bezier(.21,1.02,.73,1) forwards`:`${zt(o)} 0.4s forwards cubic-bezier(.06,.71,.55,1)`}};b.memo(({toast:e,position:t,style:n,children:a})=>{let o=e.height?rb(e.position||t||"top-center",e.visible):{opacity:0},r=b.createElement(XI,{toast:e}),i=b.createElement(ob,{...e.ariaProps},Ni(e.message,e));return b.createElement(ab,{className:e.className,style:{...o,...n,...e.style}},typeof a=="function"?a({icon:r,message:i}):b.createElement(b.Fragment,null,r,i))});AI(b.createElement);$r`
  z-index: 9999;
  > * {
    pointer-events: auto;
  }
`;var O=Ae;const sb=({isOpen:e,onClose:t,onSuccess:n,ebookId:a,ebookPrice:o,ebookTitle:r="Suicide Note",affiliateCode:i,campaignName:l})=>{const[u,c]=b.useState(""),[d,m]=b.useState(""),[g,S]=b.useState("NGN"),[y,k]=b.useState(!1),[E,f]=b.useState(i),[h,p]=b.useState(l),[N,C]=b.useState({NGN:{symbol:"₦",code:"NGN",amount:2500,displayAmount:"2,500",paymentMethod:"paystack",icon:"🇳🇬",description:"Pay with Naira (Local cards, Bank Transfer, USSD)"},USD:{symbol:"$",code:"USD",amount:500,displayAmount:"5.00",paymentMethod:"paystack",icon:"🌍",description:"Pay with Dollars (International cards)"}});b.useEffect(()=>{e&&(async()=>{var j,X;if(!i){const Z=(j=Ue.getAffiliateCodeFromCookie)==null?void 0:j.call(Ue);Z&&(f(Z),console.log("🎯 Found affiliate code in cookie:",Z))}if(!l){const Z=(X=Ue.getCampaignFromCookie)==null?void 0:X.call(Ue);Z&&(p(Z),console.log("📊 Found campaign in cookie:",Z))}})()},[e,i,l]),b.useEffect(()=>{e&&(async()=>{const j=await Ue.getCurrencyOptions();j.success&&C(j.data)})()},[e]);const A=U=>/^[^\s@]+@[^\s@]+\.[^\s@]+$/.test(U);b.useEffect(()=>{var U;if(e){const j=document.cookie.split("; ").find(Z=>Z.startsWith("affiliate_ref="));console.log("🍪 Raw cookies:",document.cookie),console.log("🍪 Affiliate cookie found:",j);const X=(U=Ue.getAffiliateCodeFromCookie)==null?void 0:U.call(Ue);console.log("🎯 Affiliate code from cookie service:",X),console.log("🎯 Current affiliateCode state:",E)}},[e,E]);const P=async()=>{var U,j;if(console.log("🔴 AMOUNT BEING SENT:",{selectedCurrency:g,selectedOption:N[g],amount:N[g].amount,expectedDisplay:g==="NGN"?"₦2,500":"$5.00"}),!A(u)){O.error("Please enter a valid email");return}console.log("📦 GuestCheckoutModal props:",{ebookId:a,ebookPrice:o,ebookTitle:r,affiliateCode:E,campaignName:h,currency:g}),k(!0);try{const X=N[g],Z={ebookId:String(a),email:u.trim(),name:d.trim()||u.split("@")[0],amount:X.amount,currency:g};E&&E.trim()!==""?(Z.affiliateCode=String(E).trim(),console.log("🎯 Adding affiliate code to payment:",E)):console.log("ℹ️ No affiliate code found for this payment"),Z.campaignName=(h==null?void 0:h.trim())||"direct-purchase",console.log("📤 Sending payment data with affiliate:",{...Z,hasAffiliate:!!Z.affiliateCode});const ne=await Ue.initializePayment(Z);if(console.log("✅ Payment initialization result:",ne),ne!=null&&ne.success){const we=((U=ne.data)==null?void 0:U.authorizationUrl)||((j=ne.data)==null?void 0:j.authorization_url);if(we){console.log(`🔗 Redirecting to Paystack (${g}) with affiliate:`,E||"none");const R={reference:ne.data.reference,ebookTitle:r,amount:g==="USD"?5:o,currency:g,affiliateCode:E,timestamp:new Date().toISOString()};localStorage.setItem("pending_purchase",JSON.stringify(R)),console.log("💾 Saved pending purchase with affiliate:",R),window.location.href=we}else console.error("❌ No authorization URL in response:",ne),O.error("Payment initialization failed - no payment link generated")}else console.error("❌ Payment initialization failed:",ne),O.error((ne==null?void 0:ne.error)||"Payment initialization failed")}catch(X){console.error("❌ Payment failed:",X),O.error((X==null?void 0:X.message)||"Payment failed")}finally{k(!1)}};if(!e)return null;const B=N[g];return s.createElement("div",{className:J.modalOverlay},s.createElement("div",{className:J.modalContainer},s.createElement("div",{className:J.modalContent},s.createElement("div",{className:J.modalHeader},s.createElement("button",{onClick:t,className:J.closeButton,disabled:y},s.createElement(W,{name:"X"})),s.createElement("h2",{className:J.modalTitle},"Complete Your Purchase")),s.createElement("div",{className:J.priceSection},E&&s.createElement("div",{className:J.affiliateBadge},s.createElement("span",{className:J.affiliateIcon},"🎯"),s.createElement("span",{className:J.affiliateText},"Referred by affiliate")),s.createElement("div",{className:J.currencyToggle},s.createElement("button",{className:`${J.currencyButton} ${g==="NGN"?J.active:""}`,onClick:()=>S("NGN"),disabled:y},s.createElement("span",{className:J.currencyIcon},N.NGN.icon),s.createElement("span",{className:J.currencyCode},"NGN"),s.createElement("span",{className:J.currencyPrice},N.NGN.symbol,N.NGN.displayAmount),s.createElement("span",{className:J.currencyMethod},"Paystack")),s.createElement("button",{className:`${J.currencyButton} ${g==="USD"?J.active:""}`,onClick:()=>S("USD"),disabled:y},s.createElement("span",{className:J.currencyIcon},N.USD.icon),s.createElement("span",{className:J.currencyCode},"USD"),s.createElement("span",{className:J.currencyPrice},N.USD.symbol,N.USD.displayAmount),s.createElement("span",{className:J.currencyMethod},"Paystack"))),s.createElement("p",{className:J.priceDescription},B.description)),s.createElement("div",{className:J.stepContent},s.createElement("div",{className:J.formGroup},s.createElement("label",null,"Email Address *"),s.createElement("input",{type:"email",value:u,onChange:U=>c(U.target.value),disabled:y,placeholder:"you@example.com",autoFocus:!0})),s.createElement("div",{className:J.formGroup},s.createElement("label",null,"Your Name (Optional)"),s.createElement("input",{type:"text",value:d,onChange:U=>m(U.target.value),disabled:y,placeholder:"Enter your name"})),s.createElement("button",{onClick:P,disabled:y||!A(u),className:J.submitButton},y?s.createElement(s.Fragment,null,s.createElement("span",{className:J.spinner}),s.createElement("span",null,"Processing...")):s.createElement(s.Fragment,null,s.createElement("span",null,"Pay ",B.symbol,B.displayAmount),s.createElement("span",{className:J.arrow},"→"))),E&&s.createElement("div",{className:J.affiliateNote},s.createElement(W,{name:"Gift",className:J.affiliateNoteIcon}),s.createElement("span",null,"You were referred by an affiliate. They'll earn commission on your purchase.")),s.createElement("div",{className:J.paymentFeatures},s.createElement("div",{className:J.featureItem},s.createElement(W,{name:"Shield",className:J.featureIcon}),s.createElement("span",null,"Secure Payment")),s.createElement("div",{className:J.featureItem},s.createElement(W,{name:"Lock",className:J.featureIcon}),s.createElement("span",null,"Encrypted Transaction")),s.createElement("div",{className:J.featureItem},s.createElement(W,{name:"CheckCircle",className:J.featureIcon}),s.createElement("span",null,"Instant Access"))),s.createElement("div",{className:J.paymentNote},s.createElement(W,{name:"Info"})," Powered by Paystack - Secure payments in ",g)))))},Te=K.create({baseURL:"http://localhost:5000/api/v1",headers:{"Content-Type":"application/json"},withCredentials:!0,timeout:1e4});Te.interceptors.request.use(e=>{const t=localStorage.getItem("token");return t&&(e.headers.Authorization=`Bearer ${t}`),e},e=>Promise.reject(e));Te.interceptors.response.use(e=>e,e=>{var n;const{response:t}=e;if(t)switch(t.status){case 401:window.location.pathname.includes("/login")||(localStorage.removeItem("token"),localStorage.removeItem("user"),window.location.href="/login");break;case 403:O.error("You do not have permission to perform this action");break;case 404:console.log("Resource not found:",e.config.url);break;case 422:const a=t.data.errors||{};Object.values(a).forEach(o=>{O.error(o)});break;case 500:O.error("Server error. Please try again later.");break;default:O.error(((n=t.data)==null?void 0:n.message)||"An error occurred")}else e.code==="ECONNABORTED"?O.error("Request timeout. Please check your connection."):navigator.onLine?O.error("Network error. Please check your connection."):O.error("No internet connection. Please check your network.");return Promise.reject(e)});const ib={getAll:e=>Te.get("/ebooks",{params:e}),getById:e=>Te.get(`/ebooks/${e}`),getPreview:e=>Te.get(`/ebooks/${e}/preview`),getContent:(e,t)=>Te.get(`/ebooks/${e}/content`,{params:{code:t}}),getReviews:(e,t)=>Te.get(`/ebooks/${e}/reviews`,{params:t}),addReview:(e,t)=>Te.post(`/ebooks/${e}/reviews`,t),markHelpful:(e,t)=>Te.post(`/ebooks/${e}/reviews/${t}/helpful`),search:e=>Te.get("/ebooks/search",{params:{query:e}}),getFeatured:()=>Te.get("/ebooks/featured"),getCategories:()=>Te.get("/ebooks/categories"),validateAccessCode:e=>Te.post("/ebooks/validate-access-code",{code:e}),getReadingProgress:e=>Te.get(`/ebooks/${e}/progress`),saveReadingProgress:(e,t)=>Te.post(`/ebooks/${e}/progress`,t),testConnection:()=>Te.get("/ebooks/debug/test-route"),checkEbook:e=>Te.get(`/ebooks/debug/check-ebook/${e}`)},dc=`SUICIDE NOTE
by Loba Yusuf
...
[CONTENT CONTINUES BUT BLURS COMPLETELY]`,lb=()=>{var Ve,Be;const e=pa();Mn();const[t,n]=b.useState(!1),[a,o]=b.useState(""),[r,i]=b.useState(!1),[l,u]=b.useState(!1),[c,d]=b.useState(""),[m,g]=b.useState(""),[S,y]=b.useState(""),[k,E]=b.useState(!1),[f,h]=b.useState(!1),[p,N]=b.useState(!1),[C,A]=b.useState(!1),[P,B]=b.useState(!1),[U,j]=b.useState(20),[X,Z]=b.useState([{name:"Chioma A.",rating:5,text:"This book saved my life. I was in a dark place and Eliora's story showed me I wasn't alone. The honest portrayal of depression in Nigeria is exactly what we need.",date:"2 weeks ago"},{name:"Tunde O.",rating:5,text:"As someone who has struggled with mental health, this resonated deeply. Loba Yusuf captures the Lagos experience perfectly - the isolation in crowds, the pressure to succeed.",date:"1 month ago"},{name:"Amara K.",rating:5,text:"Raw, honest, and hopeful. Every Nigerian should read this. It's time we stop treating mental health as a 'white people problem' and start having real conversations.",date:"3 weeks ago"}]),[ne,we]=b.useState([{q:"Can I download the ebook?",a:"No, this is a web-based reading experience. You'll receive an access code after purchase that lets you read the full book online anytime. This protects the author's intellectual property while giving you unlimited access."},{q:"How does the affiliate program work?",a:"Promote the book using your unique affiliate link and earn 50% commission on every sale. You'll receive your commission via Paystack within 7 days of each sale."},{q:"Is this book appropriate for all ages?",a:"This book is recommended for readers 18+ due to mature themes including depression, suicidal ideation, and mental health struggles. Please read the content warnings before purchasing."},{q:"What payment methods do you accept?",a:"We accept all major cards, bank transfers, and USSD payments through Paystack's secure payment gateway."}]),[R,ee]=b.useState({readers:127,rating:4.9,chapters:10,price:3e3,affiliateCommission:1500,affiliateRate:.5});b.useEffect(()=>{console.log("🍪 All cookies on page load:",document.cookie);const F=document.cookie.replace(/(?:(?:^|.*;\s*)affiliate_ref\s*\=\s*([^;]*).*$)|^.*$/,"$1");console.log("🍪 affiliate_ref from cookies:",F)},[]),b.useEffect(()=>{(async()=>{const q=new URLSearchParams(window.location.search),$=q.get("reference")||q.get("trxref");if(console.log("🔍 Payment callback detected:",{reference:$,fullUrl:window.location.href}),$){window.history.replaceState({},document.title,window.location.pathname);try{O.loading("Verifying your payment...");const oe=await Ue.verifyPayment($);if(oe.success){const fe={purchase:oe.data,accessCode:oe.data.accessCode||"SN-"+Math.random().toString(36).substring(2,10).toUpperCase(),timestamp:new Date().toISOString()};localStorage.setItem("recent_purchase",JSON.stringify(fe)),oe.data.accessCode&&localStorage.setItem("ebook_access_suicide-note-2026",oe.data.accessCode),console.log("✅ Payment verified, redirecting to thank you page"),O.dismiss(),setTimeout(()=>{window.location.href="https://suicidenote.onrender.com/thank-you"},300);return}else O.error("Payment verification failed. Please contact support.")}catch(oe){console.error("Payment verification error:",oe),O.error("Failed to verify payment. Please try again.")}finally{O.dismiss()}}localStorage.getItem("ebook_access_suicide-note-2026")&&i(!0),ae()})()},[e]);const ae=async()=>{var q;const F="suicide-note-2026";try{const $=await ib.getById(F);if(console.log("🔍 API Response:",$.data),(q=$.data)!=null&&q.success){const H=$.data.data.ebook||$.data.data;if(console.log("📦 Ebook data:",H),console.log("💰 Price from API:",H.price),H.price||H.salesCount||H.ratings){const oe=H.price||H.currentPrice,fe=oe===25?3e3:oe||R.price;ee(We=>{var L;return{...We,readers:H.salesCount||H.readerCount||We.readers,rating:((L=H.ratings)==null?void 0:L.average)||H.averageRating||We.rating,price:fe,affiliateCommission:Math.floor(fe*(H.affiliateCommissionRate||H.affiliateRate||.5)),affiliateRate:H.affiliateCommissionRate||H.affiliateRate||.5}})}}}catch{console.log("Using default data")}},x=()=>{E(!1),N(!0)},z=async F=>{try{E(!0);const $=new URLSearchParams(window.location.search).get("ref"),H=await Ue.initializePayment("suicide-note-2026",$);H.success||O.error(H.error||"Failed to initialize payment")}catch(q){console.error("Payment processing error:",q),O.error("Payment processing failed. Please try again.")}finally{E(!1)}},D=async()=>{if(!a.trim()){O.error("Please enter an access code");return}console.log("🎬 handleAccessCode started with code:",a),E(!0);try{const F=await Ue.validateAccessCode(a,"suicide-note-2026");if(console.log("🔑 Validation result:",F),F.success){console.log("✅ Access granted!");const q=a.trim().toUpperCase();localStorage.setItem("ebook_access_suicide-note-2026",q),console.log("🧭 Attempting navigation methods..."),console.log("Method 1: Direct URL redirect"),window.location.href=`/read/suicide-note-2026?accessCode=${q}&validated=true`,setTimeout(()=>{console.log("Method 2: Using navigate()"),e("/read/suicide-note-2026",{state:{accessCode:q,validationData:F.data,timestamp:new Date().toISOString()},replace:!0})},100),setTimeout(()=>{console.log("Method 3: History API"),window.history.pushState({accessCode:q},"","/read/suicide-note-2026"),window.dispatchEvent(new PopStateEvent("popstate"))},200),O.success("Access granted! Redirecting...")}else console.error("❌ Access denied:",F.error),O.error(F.error||"Invalid access code"),o("")}catch(F){console.error("🔥 Validation error:",F),O.error("Failed to validate access code")}finally{E(!1)}},G=async()=>{if(!c){O.error("Please enter your email address");return}if(!c.includes("@")){O.error("Please enter a valid email address");return}h(!0);try{console.log("🔗 Generating affiliate link for:",c),console.log("📧 With name:",m);const F=await De.registerAffiliate(c,m);if(console.log("📝 Registration result:",F),!F.success){O.error(F.error||"Failed to register as affiliate"),h(!1);return}if(F.affiliate){const q=F.affiliate.link||De.generateShareLink(F.affiliate.code);y(q),A(!0),localStorage.setItem("affiliate_info",JSON.stringify({affiliateCode:F.affiliate.code,email:c,name:m,link:q,generatedAt:new Date().toISOString()})),O.success("🎉 Affiliate link generated! Check your email for dashboard access."),setTimeout(()=>{const $=document.getElementById("affiliate-link-section");$&&$.scrollIntoView({behavior:"smooth",block:"start"})},300)}else{const q=Date.now(),$=Math.random().toString(36).substr(2,8).toUpperCase(),H=`AFF${q.toString(36).toUpperCase()}${$}`,oe=De.generateShareLink(H);y(oe),A(!0),O.success("Affiliate link generated!")}}catch(F){console.error("❌ Affiliate generation error:",F),O.error("Failed to generate affiliate link. Please try again.")}finally{h(!1)}},V=()=>{S&&(navigator.clipboard.writeText(S),B(!0),setTimeout(()=>B(!1),2e3),O.success("Link copied to clipboard!"))},ge=F=>`₦${(F*R.affiliateCommission).toLocaleString()}`,Ie=()=>{if(!r){const F=dc.split(`
`);return s.createElement("div",{className:v.ebookContent},F.map((q,$)=>{let H=0;const oe=F.length,fe=Math.floor(oe*.6);return $>fe&&(H=($-fe)/(oe-fe)*10),s.createElement("p",{key:$,className:v.contentLine,style:{filter:H>0?`blur(${H}px)`:"none",userSelect:H>5?"none":"auto"}},q)}),s.createElement("div",{className:v.purchaseOverlay},s.createElement("button",{onClick:x,className:`btn btn-primary ${v.purchaseBtn}`,disabled:k},k?"Processing...":`Buy Full Book - ₦${R.price.toLocaleString()}`),s.createElement("p",{className:v.purchaseText},"Continue reading instantly after purchase")))}return s.createElement("div",{className:v.ebookContent},s.createElement("p",{className:v.fullAccessText},"You have full access to this book. Thank you for your purchase!"),dc.split(`
`).map((F,q)=>s.createElement("p",{key:q,className:v.contentLine},F)),s.createElement("div",{className:v.successMessage},s.createElement("p",{className:v.successText},"[Full book content continues for all chapters...]"),s.createElement("p",{className:v.successNote},"In production, the complete book would load here after payment verification")))};return l?s.createElement("div",{className:v.readerContainer},s.createElement("div",{className:v.readerHeader},s.createElement("div",{className:"container"},s.createElement("div",{className:v.readerNav},s.createElement("h1",{className:v.readerTitle},"Suicide Note"),s.createElement("button",{onClick:()=>u(!1),className:v.backButton},"← Back to Homepage")))),s.createElement("div",{className:v.readerContent},s.createElement("div",{className:"container"},Ie()))):s.createElement("div",{className:v.container},s.createElement(sb,{isOpen:p,onClose:()=>N(!1),onSuccess:z,ebookId:"suicide-note-2026",ebookPrice:R.price,ebookTitle:"Suicide Note",affiliateCode:new URLSearchParams(window.location.search).get("ref")}),s.createElement("nav",{className:v.navbar},s.createElement("div",{className:"container"},s.createElement("div",{className:v.navContent},s.createElement("div",{className:v.logo},s.createElement(W,{name:"Book",className:v.logoIcon}),s.createElement("span",{className:v.logoText},"Suicide Note")),s.createElement("div",{className:v.desktopNav},s.createElement("a",{href:"#preview",className:v.navLink},"Preview"),s.createElement("a",{href:"#reviews",className:v.navLink},"Reviews"),s.createElement("a",{href:"#faq",className:v.navLink},"FAQ"),s.createElement("a",{href:"#affiliate",className:v.navLink},"Affiliate"),s.createElement("button",{onClick:x,className:"btn btn-primary",disabled:k},k?"Processing...":"Buy Now")),s.createElement("button",{className:v.mobileMenuButton,onClick:()=>n(!t),disabled:k},s.createElement(W,{name:t?"X":"Menu"})))),t&&s.createElement("div",{className:v.mobileMenu},s.createElement("div",{className:v.mobileMenuContent},s.createElement("a",{href:"#preview",className:v.mobileNavLink},"Preview"),s.createElement("a",{href:"#reviews",className:v.mobileNavLink},"Reviews"),s.createElement("a",{href:"#faq",className:v.mobileNavLink},"FAQ"),s.createElement("a",{href:"#affiliate",className:v.mobileNavLink},"Affiliate"),s.createElement("button",{onClick:x,className:"btn btn-primary w-full",disabled:k},k?"Processing...":"Buy Now")))),s.createElement("section",{className:v.hero},s.createElement("div",{className:"container"},s.createElement("div",{className:v.heroGrid},s.createElement("div",{className:v.heroContent},s.createElement("span",{className:"badge badge-red"},"#1 Nigerian Mental Health Fiction"),s.createElement("h1",{className:v.heroTitle},"A Story of Darkness, Hope, and Healing"),s.createElement("p",{className:v.heroSubtitle},"Follow Eliora's journey from the edge of despair to finding community, purpose, and reasons to live in Lagos, Nigeria."),s.createElement("div",{className:"rating mb-6"},[...Array(5)].map((F,q)=>s.createElement(W,{key:q,name:"Star",className:"star"})),s.createElement("span",{className:v.ratingText},R.rating.toFixed(1),"/5 from ",R.readers," readers")),s.createElement("div",{className:v.ctaButtons},s.createElement("button",{onClick:x,className:`btn btn-primary ${v.ctaButton}`,disabled:k},k?"Processing...":`Buy Now - ₦${R.price.toLocaleString()}`),s.createElement("button",{onClick:()=>u(!0),className:`btn btn-outline ${v.ctaButton}`},"Read Preview")),s.createElement("p",{className:v.instantAccess},"Instant access • Read online • No downloads needed")),s.createElement("div",{className:v.heroCard},s.createElement("div",{className:v.bookCoverContainer},s.createElement("img",{src:"/images/suicide-note-cover.jpeg",alt:"Suicide Note Book Cover",className:v.bookCover,onError:F=>{F.target.onerror=null,F.target.src="https://via.placeholder.com/400x600?text=Suicide+Note+Cover"}}),s.createElement("div",{className:v.bookCoverBadge},s.createElement("span",{className:v.bestsellerBadge},"#1 Bestseller"))))))),s.createElement("section",{id:"preview",className:v.previewSection},s.createElement("div",{className:"container"},s.createElement("div",{className:"text-center mb-12"},s.createElement("h2",{className:v.sectionTitle},"Preview the First Chapter"),s.createElement("p",{className:v.sectionSubtitle},"Read before you buy - see if this book resonates with you")),s.createElement("div",{className:v.previewCard},s.createElement("div",{className:v.previewHeader},s.createElement("h3",{className:v.previewTitle},"Chapter One: The Note Begins"),s.createElement("button",{onClick:()=>u(!0),className:v.openReaderButton},s.createElement(W,{name:"Eye",className:v.eyeIcon}),s.createElement("span",null,"Open Reader"))),s.createElement("div",{className:v.previewContent},s.createElement("p",{className:v.previewText},`"I'm writing this because I need someone to understand. Not my mother, who will cry and ask what she did wrong. Not my father, who will wonder where he failed as a man..."`),s.createElement("p",{className:v.previewNote},"Preview continues in the reader. Purchase to read all ",R.chapters," chapters.")),s.createElement("div",{className:v.accessForm},s.createElement("div",{className:v.accessInputGroup},s.createElement("input",{type:"text",placeholder:"Enter access code from purchase",value:a,onChange:F=>o(F.target.value),className:"form-input",disabled:k}),s.createElement("button",{onClick:D,className:"btn btn-secondary",disabled:k},k?"Validating...":"Access Full Book")),s.createElement("p",{className:v.accessNote},"Already purchased? Enter your access code to read the full book"))))),s.createElement("section",{className:v.statsSection},s.createElement("div",{className:"container"},s.createElement("div",{className:v.statsGrid},s.createElement("div",{className:v.statItem},s.createElement("div",{className:v.statNumber},R.readers,"+"),s.createElement("div",{className:v.statLabel},"Happy Readers")),s.createElement("div",{className:v.statItem},s.createElement("div",{className:v.statNumber},R.rating.toFixed(1),"/5"),s.createElement("div",{className:v.statLabel},"Average Rating")),s.createElement("div",{className:v.statItem},s.createElement("div",{className:v.statNumber},R.chapters),s.createElement("div",{className:v.statLabel},"Powerful Chapters")),s.createElement("div",{className:v.statItem},s.createElement("div",{className:v.statNumber},"₦",R.price.toLocaleString()),s.createElement("div",{className:v.statLabel},"One-Time Payment"))))),s.createElement("section",{id:"reviews",className:v.reviewsSection},s.createElement("div",{className:"container"},s.createElement("div",{className:"text-center mb-12"},s.createElement("h2",{className:v.sectionTitle},"What Readers Are Saying"),s.createElement("p",{className:v.sectionSubtitle},"Real reviews from real readers")),s.createElement("div",{className:v.reviewsGrid},X.map((F,q)=>s.createElement("div",{key:q,className:"card"},s.createElement("div",{className:v.reviewHeader},s.createElement("div",{className:"rating"},[...Array(F.rating||5)].map(($,H)=>s.createElement(W,{key:H,name:"Star",className:"star"}))),s.createElement("span",{className:v.reviewDate},F.date||"Recently")),s.createElement("p",{className:v.reviewText},F.text),s.createElement("p",{className:v.reviewer},"- ",F.name||"Anonymous Reader")))),s.createElement("div",{className:"text-center mt-12"},s.createElement("div",{className:v.ratingBadge},s.createElement("div",{className:"rating"},[...Array(5)].map((F,q)=>s.createElement(W,{key:q,name:"Star",className:"star",style:{width:"1.5rem",height:"1.5rem"}}))),s.createElement("span",{className:v.ratingScore},R.rating.toFixed(1)," out of 5 stars"))))),s.createElement("section",{id:"affiliate",className:v.affiliateSection},s.createElement("div",{className:"container"},s.createElement("div",{className:"text-center"},s.createElement("span",{className:"badge badge-green"},"💰 Earn ₦",R.affiliateCommission.toLocaleString()," Per Sale"),s.createElement("h2",{className:`${v.sectionTitle} mt-4`},"Become an Affiliate Partner"),s.createElement("p",{className:v.affiliateSubtitle},"Earn ",s.createElement("strong",{className:v.highlightGreen},Math.round(R.affiliateRate*100),"% commission")," on every sale. Share a book that matters and get paid for it."),s.createElement("div",{className:v.affiliateStats},s.createElement("p",null,"Sell 2 books = ",s.createElement("strong",{className:v.highlightGreen},"₦",(R.affiliateCommission*2).toLocaleString())),s.createElement("p",null,"Sell 20 books = ",s.createElement("strong",{className:v.highlightGreen},"₦",(R.affiliateCommission*20).toLocaleString())),s.createElement("p",null,"Sell 50 books = ",s.createElement("strong",{className:v.highlightGreen},"₦",(R.affiliateCommission*50).toLocaleString()))),s.createElement("div",{className:v.affiliateCard},s.createElement("div",{className:v.successStory},s.createElement("div",{className:v.storyContent},s.createElement("div",{className:v.storyAvatar},((Be=(Ve=X.find(F=>{var q;return(q=F.name)==null?void 0:q.includes("Tunde")}))==null?void 0:Ve.name)==null?void 0:Be.charAt(0))||"T"),s.createElement("div",null,s.createElement("p",{className:v.storyText},`"I've earned `,s.createElement("strong",{className:v.highlightGreen},"₦",(R.affiliateCommission*37.6).toLocaleString()," in 2 months"),' just by sharing this book on my Twitter. It helped me with my own mental health journey, and now I help others find it while earning."'),s.createElement("p",{className:v.storyAuthor},"- Tunde O., Affiliate Partner")))),s.createElement("div",{className:v.affiliateSteps},s.createElement("div",{className:v.step},s.createElement("div",{className:v.stepIcon},s.createElement(W,{name:"Users"})),s.createElement("h3",{className:v.stepTitle},"1. Sign Up Free"),s.createElement("p",{className:v.stepDescription},"Get your unique affiliate link instantly - no approval needed")),s.createElement("div",{className:v.step},s.createElement("div",{className:v.stepIcon},s.createElement(W,{name:"MessageCircle"})),s.createElement("h3",{className:v.stepTitle},"2. Share Everywhere"),s.createElement("p",{className:v.stepDescription},"Twitter, WhatsApp, Facebook, Instagram, your blog")),s.createElement("div",{className:v.step},s.createElement("div",{className:v.stepIcon},s.createElement(W,{name:"Award"})),s.createElement("h3",{className:v.stepTitle},"3. Earn ₦",R.affiliateCommission.toLocaleString()," Each"),s.createElement("p",{className:v.stepDescription},"Get ",Math.round(R.affiliateRate*100),"% commission paid via Paystack within 7 days"))),s.createElement("div",{className:"pro-tip"},s.createElement("h3",{className:v.explanationTitle},"Why We Offer ",Math.round(R.affiliateRate*100),"% Commission"),s.createElement("p",{className:v.explanationText},"Most Nigerian ebooks offer 20-30%. We offer ",s.createElement("strong",null,Math.round(R.affiliateRate*100),"%")," because this book changes lives, and we want you to be genuinely motivated to share it. When you succeed, we succeed. It's that simple.")),s.createElement("div",{className:v.affiliateForm,id:"affiliate-link-section"},s.createElement("h3",{className:v.formTitle},"Get Your Affiliate Link Now"),C?s.createElement("div",{className:v.linkBox},s.createElement("p",{className:v.linkLabel},"🎉 Your affiliate link is ready!"),s.createElement("code",{className:v.linkCode},S),s.createElement("div",{className:v.linkActions},s.createElement("button",{onClick:V,className:v.copyButtonLarge},s.createElement(W,{name:"Copy"})," ",P?"Copied!":"Copy Link")),s.createElement("div",{className:v.socialShare},s.createElement("p",{className:v.shareLabel},"Share on:"),s.createElement("div",{className:v.socialButtons},s.createElement("a",{href:`https://twitter.com/intent/tweet?text=${encodeURIComponent("I just earned from sharing this powerful book about mental health in Nigeria. Join me as an affiliate and earn 50% commission!")}&url=${encodeURIComponent(S)}`,target:"_blank",rel:"noopener noreferrer",className:v.twitterShare},s.createElement(W,{name:"Twitter"})," Twitter"),s.createElement("a",{href:`https://wa.me/?text=${encodeURIComponent(`Check out this powerful book about mental health in Nigeria. I'm earning as an affiliate and you can too! ${S}`)}`,target:"_blank",rel:"noopener noreferrer",className:v.whatsappShare},s.createElement(W,{name:"MessageCircle"})," WhatsApp"),s.createElement("a",{href:`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(S)}`,target:"_blank",rel:"noopener noreferrer",className:v.facebookShare},s.createElement(W,{name:"Facebook"})," Facebook"))),s.createElement("div",{className:v.calculator},s.createElement("h4",{className:v.calculatorTitle},"💰 Estimate Your Earnings"),s.createElement("div",{className:v.sliderContainer},s.createElement("label",{className:v.sliderLabel},"How many sales per month?"),s.createElement("input",{type:"range",min:"5",max:"100",step:"5",value:U,onChange:F=>j(Number(F.target.value)),className:v.slider}),s.createElement("div",{className:v.sliderLabels},s.createElement("span",null,"5 sales"),s.createElement("span",null,"100 sales"))),s.createElement("div",{className:v.earningsDisplay},s.createElement("div",{className:v.earningsAmount},ge(U)),s.createElement("p",{className:v.earningsText},"per month with ",U," sales"))),s.createElement("p",{className:v.linkNote},"Share this link and earn ₦",R.affiliateCommission.toLocaleString()," per sale! We'll email you tracking updates and payout information."),s.createElement("p",{className:v.emailConfirmation},s.createElement("small",null,"We've sent a confirmation to ",s.createElement("strong",null,c)))):s.createElement(s.Fragment,null,s.createElement("div",{className:v.formGroup},s.createElement("input",{type:"text",placeholder:"Your name (optional)",value:m,onChange:F=>g(F.target.value),className:"form-input",disabled:f})),s.createElement("div",{className:v.formGroup},s.createElement("input",{type:"email",placeholder:"Enter your email *",value:c,onChange:F=>d(F.target.value),className:"form-input",disabled:f,required:!0})),s.createElement("button",{onClick:G,className:"btn btn-green",disabled:f||!c||!c.includes("@")},f?s.createElement(s.Fragment,null,s.createElement("span",{className:"spinner-sm mr-2"}),"Processing..."):"Get My Affiliate Link →"),s.createElement("p",{className:v.formNote},"No approval process. Start earning immediately."))))))),s.createElement("section",{id:"faq",className:v.faqSection},s.createElement("div",{className:"container"},s.createElement("div",{className:"text-center mb-12"},s.createElement("h2",{className:v.sectionTitle},"Frequently Asked Questions"),s.createElement("p",{className:v.sectionSubtitle},"Everything you need to know")),s.createElement("div",{className:v.faqGrid},ne.map((F,q)=>s.createElement("div",{key:q,className:"card"},s.createElement("h3",{className:v.faqQuestion},F.q),s.createElement("p",{className:v.faqAnswer},F.a)))))),s.createElement("section",{className:v.finalCTA},s.createElement("div",{className:"container text-center"},s.createElement("h2",{className:v.ctaTitle},"Ready to Read Eliora's Story?"),s.createElement("p",{className:v.ctaSubtitle},"Join ",R.readers,"+ readers who found hope, understanding, and connection in this powerful story"),s.createElement("button",{onClick:x,className:`btn ${v.ctaButton}`,disabled:k},k?"Processing...":`Buy Now - ₦${R.price.toLocaleString()}`),s.createElement("p",{className:v.ctaFeatures},"✓ Instant access ✓ Read online anytime ✓ Secure payment via Paystack"))),s.createElement("footer",{className:v.footer},s.createElement("div",{className:"container"},s.createElement("div",{className:v.footerGrid},s.createElement("div",{className:v.footerSection},s.createElement("h3",{className:v.footerTitle},"About the Book"),s.createElement("p",{className:v.footerText},"A powerful Nigerian fiction exploring mental health, depression, and the journey to healing through community and connection.")),s.createElement("div",{className:v.footerSection},s.createElement("h3",{className:v.footerTitle},"Crisis Resources"),s.createElement("p",{className:v.footerText},"Nigeria Emergency: 112"),s.createElement("p",{className:v.footerText},"Lagos Emergency: 767")),s.createElement("div",{className:v.footerSection},s.createElement("h3",{className:v.footerTitle},"Connect"),s.createElement("p",{className:v.footerText},"Email: support@suicidenote.com"),s.createElement("p",{className:v.footerText},"Follow @loba_yusuf on X"))),s.createElement("div",{className:v.footerBottom},s.createElement("p",{className:v.copyright},"© 2026 Loba Yusuf. All rights reserved. | This is a work of fiction."),s.createElement("p",{className:v.crisisNote},"If you're experiencing suicidal thoughts, please seek help immediately. You are not alone.")))))},ub="_container_7lc5b_1",cb="_header_7lc5b_13",db="_headerContent_7lc5b_23",hb="_logoIcon_7lc5b_37",mb="_logoText_7lc5b_49",fb="_mainContent_7lc5b_63",pb="_successCard_7lc5b_73",gb="_successHeader_7lc5b_83",yb="_successCheck_7lc5b_97",wb="_checkIcon_7lc5b_119",vb="_successTitle_7lc5b_131",kb="_successSubtitle_7lc5b_143",Ib="_accessSection_7lc5b_155",bb="_accessCard_7lc5b_163",Eb="_accessTitle_7lc5b_179",Sb="_codeDisplay_7lc5b_195",_b="_codeText_7lc5b_215",Nb="_copyButton_7lc5b_231",Cb="_copyIcon_7lc5b_265",Tb="_startReadingButton_7lc5b_275",xb="_bookIcon_7lc5b_289",Ab="_arrowIcon_7lc5b_289",Pb="_codeNote_7lc5b_299",Lb="_warningText_7lc5b_311",Bb="_affiliateCard_7lc5b_323",Rb="_affiliateContent_7lc5b_339",Mb="_affiliateTitle_7lc5b_347",Ob="_affiliateSubtitle_7lc5b_361",Db="_valueProposition_7lc5b_373",Fb="_valueContent_7lc5b_387",jb="_valueTitle_7lc5b_397",zb="_valueList_7lc5b_411",Wb="_valueItem_7lc5b_419",Ub="_checkCircle_7lc5b_433",$b="_smallCheckIcon_7lc5b_457",Hb="_highlightGreen_7lc5b_469",Yb="_earningsCard_7lc5b_477",Gb="_earningsTitle_7lc5b_489",Vb="_earningsList_7lc5b_503",qb="_earningItem_7lc5b_513",Jb="_earningHeader_7lc5b_525",Kb="_earningLabel_7lc5b_539",Qb="_earningAmount_7lc5b_547",Xb="_earningNote_7lc5b_559",Zb="_premiumEarning_7lc5b_569",e1="_premiumLabel_7lc5b_583",t1="_premiumAmount_7lc5b_591",n1="_premiumNote_7lc5b_601",a1="_socialProof_7lc5b_613",o1="_socialContent_7lc5b_631",r1="_socialAvatar_7lc5b_643",s1="_socialText_7lc5b_671",i1="_highlightYellow_7lc5b_685",l1="_socialAuthor_7lc5b_695",u1="_socialStats_7lc5b_705",c1="_calculatorTitle_7lc5b_725",d1="_calculatorContent_7lc5b_741",h1="_sliderLabel_7lc5b_751",m1="_sliderContainer_7lc5b_765",f1="_slider_7lc5b_751",p1="_sliderLabels_7lc5b_811",g1="_earningsDisplay_7lc5b_827",y1="_earningsAmount_7lc5b_843",w1="_earningsText_7lc5b_855",v1="_yearlyEarnings_7lc5b_863",k1="_formTitle_7lc5b_877",I1="_signupForm_7lc5b_893",b1="_emailInput_7lc5b_903",E1="_generateButton_7lc5b_915",S1="_dollarIcon_7lc5b_931",_1="_formNote_7lc5b_941",N1="_statsGrid_7lc5b_955",C1="_statCard_7lc5b_969",T1="_statIcon_7lc5b_983",x1="_statText_7lc5b_997",A1="_generatedLinkSection_7lc5b_1011",P1="_successMessage_7lc5b_1021",L1="_bigCheckIcon_7lc5b_1037",B1="_successHeading_7lc5b_1049",R1="_linkContainer_7lc5b_1061",M1="_linkLabel_7lc5b_1073",O1="_linkDisplay_7lc5b_1089",D1="_linkCode_7lc5b_1101",F1="_copyLinkButton_7lc5b_1125",j1="_sharingGuide_7lc5b_1163",z1="_guideTitle_7lc5b_1175",W1="_socialGrid_7lc5b_1187",U1="_socialItem_7lc5b_1199",$1="_twitterIcon_7lc5b_1213",H1="_whatsappIcon_7lc5b_1225",Y1="_facebookIcon_7lc5b_1237",G1="_emailIcon_7lc5b_1249",V1="_socialName_7lc5b_1261",q1="_socialDescription_7lc5b_1273",J1="_tipText_7lc5b_1283",K1="_emailConfirmation_7lc5b_1295",Q1="_confirmationText_7lc5b_1309",X1="_userEmail_7lc5b_1319",Z1="_confirmationNote_7lc5b_1331",eE="_whyTitle_7lc5b_1343",tE="_whyGrid_7lc5b_1359",nE="_whyCard_7lc5b_1373",aE="_whyIcon_7lc5b_1383",oE="_purpleIcon_7lc5b_1405",rE="_blueIcon_7lc5b_1417",sE="_greenIcon_7lc5b_1429",iE="_whyCardTitle_7lc5b_1441",lE="_whyCardText_7lc5b_1453",uE="_finalCTA_7lc5b_1465",cE="_finalTitle_7lc5b_1479",dE="_finalSubtitle_7lc5b_1493",hE="_readingButton_7lc5b_1503",mE="_footer_7lc5b_1519",fE="_footerContent_7lc5b_1533",pE="_footerText_7lc5b_1541",gE="_copyright_7lc5b_1551",yE="_loadingContainer_7lc5b_1669",wE="_spinner_7lc5b_1687",vE="_internationalCard_7lc5b_1717",kE="_internationalContent_7lc5b_1733",IE="_internationalTitle_7lc5b_1741",bE="_internationalSubtitle_7lc5b_1755",EE="_internationalMessage_7lc5b_1765",SE="_globeIcon_7lc5b_1789",_E="_internationalMessageTitle_7lc5b_1803",NE="_internationalMessageText_7lc5b_1817",CE="_internationalFeatures_7lc5b_1829",TE="_feature_7lc5b_1843",xE="_featureCheckIcon_7lc5b_1863",AE="_purchaseInfo_7lc5b_1879",PE="_purchaseId_7lc5b_1905",LE="_purchaseAmount_7lc5b_1907",BE="_paymentMethod_7lc5b_1909",w={container:ub,header:cb,headerContent:db,logoIcon:hb,logoText:mb,mainContent:fb,successCard:pb,successHeader:gb,successCheck:yb,checkIcon:wb,successTitle:vb,successSubtitle:kb,accessSection:Ib,accessCard:bb,accessTitle:Eb,codeDisplay:Sb,codeText:_b,copyButton:Nb,copyIcon:Cb,startReadingButton:Tb,bookIcon:xb,arrowIcon:Ab,codeNote:Pb,warningText:Lb,affiliateCard:Bb,affiliateContent:Rb,affiliateTitle:Mb,affiliateSubtitle:Ob,valueProposition:Db,valueContent:Fb,valueTitle:jb,valueList:zb,valueItem:Wb,checkCircle:Ub,smallCheckIcon:$b,highlightGreen:Hb,earningsCard:Yb,earningsTitle:Gb,earningsList:Vb,earningItem:qb,earningHeader:Jb,earningLabel:Kb,earningAmount:Qb,earningNote:Xb,premiumEarning:Zb,premiumLabel:e1,premiumAmount:t1,premiumNote:n1,socialProof:a1,socialContent:o1,socialAvatar:r1,socialText:s1,highlightYellow:i1,socialAuthor:l1,socialStats:u1,calculatorTitle:c1,calculatorContent:d1,sliderLabel:h1,sliderContainer:m1,slider:f1,sliderLabels:p1,earningsDisplay:g1,earningsAmount:y1,earningsText:w1,yearlyEarnings:v1,formTitle:k1,signupForm:I1,emailInput:b1,generateButton:E1,dollarIcon:S1,formNote:_1,statsGrid:N1,statCard:C1,statIcon:T1,statText:x1,generatedLinkSection:A1,successMessage:P1,bigCheckIcon:L1,successHeading:B1,linkContainer:R1,linkLabel:M1,linkDisplay:O1,linkCode:D1,copyLinkButton:F1,sharingGuide:j1,guideTitle:z1,socialGrid:W1,socialItem:U1,twitterIcon:$1,whatsappIcon:H1,facebookIcon:Y1,emailIcon:G1,socialName:V1,socialDescription:q1,tipText:J1,emailConfirmation:K1,confirmationText:Q1,userEmail:X1,confirmationNote:Z1,whyTitle:eE,whyGrid:tE,whyCard:nE,whyIcon:aE,purpleIcon:oE,blueIcon:rE,greenIcon:sE,whyCardTitle:iE,whyCardText:lE,finalCTA:uE,finalTitle:cE,finalSubtitle:dE,readingButton:hE,footer:mE,footerContent:fE,footerText:pE,copyright:gE,loadingContainer:yE,spinner:wE,internationalCard:vE,internationalContent:kE,internationalTitle:IE,internationalSubtitle:bE,internationalMessage:EE,globeIcon:SE,internationalMessageTitle:_E,internationalMessageText:NE,internationalFeatures:CE,feature:TE,featureCheckIcon:xE,purchaseInfo:AE,purchaseId:PE,purchaseAmount:LE,paymentMethod:BE},RE=({onBackToHome:e})=>{var q;const[t,n]=b.useState(""),[a,o]=b.useState(""),[r,i]=b.useState(!1),[l,u]=b.useState(""),[c,d]=b.useState(!1),[m,g]=b.useState(!1),[S,y]=b.useState(!1),[k,E]=b.useState(20),[f,h]=b.useState(null),[p,N]=b.useState(""),[C,A]=b.useState(!0),[P,B]=b.useState(null),[U,j]=b.useState("NGN"),[X,Z]=b.useState("paystack"),[ne,we]=b.useState(""),[R,ee]=b.useState(.5),[ae,x]=b.useState(1250),z=Mn(),D=pa();b.useEffect(()=>{(async()=>{var H,oe,fe;try{A(!0),console.log("🔍 ThankYouPage mounted, checking URL...");const We=new URLSearchParams(z.search),L=We.get("reference"),it=We.get("trxref"),lt=We.get("session_id"),xt=L||it||lt;if(console.log("📋 URL parameters:",{reference:L,trxref:it,sessionId:lt,paymentRef:xt,fullUrl:window.location.href}),xt){console.log("✅ Found payment reference:",xt);const Se=await Ue.verifyPayment(xt);if(console.log("🔍 Verification result:",Se),Se.success){console.log("🎉 Payment verified successfully");const ie=((H=Se.data)==null?void 0:H.purchase)||Se.data,Re=(oe=Se.data)==null?void 0:oe.accessCode,Hr=(fe=Se.data)==null?void 0:fe.verifiedData,Yr=(ie==null?void 0:ie.currency)||"NGN",Gr=(ie==null?void 0:ie.paymentMethod)||"paystack";console.log("🔑 Access code received:",Re),console.log("💰 Currency:",Yr),console.log("💳 Payment method:",Gr),h(ie),N(Re),j(Yr),Z(Gr);const cm=(ie==null?void 0:ie.amount)||2500,dm=Math.floor(cm*.5);x(dm),localStorage.setItem("recent_purchase",JSON.stringify({purchase:ie,accessCode:Re,reference:xt,verifiedData:Hr,currency:Yr,paymentMethod:Gr,timestamp:new Date().toISOString()})),Re&&localStorage.setItem("ebook_access_suicide-note-2026",Re),localStorage.removeItem("pending_purchase"),O.success("🎉 Payment successful! Your access code is ready.")}else{console.error("❌ Payment verification failed:",Se.error);const ie=localStorage.getItem("pending_purchase");if(ie)try{const Re=JSON.parse(ie);console.log("📂 Using cached purchase info:",Re);const Hr=`SN-${Date.now().toString(36).toUpperCase()}-${Math.random().toString(36).substr(2,6).toUpperCase()}`;N(Hr),h(Re),j(Re.currency||"NGN"),Z(Re.paymentMethod||"paystack"),O.warning("Payment verification pending. Using cached purchase info.")}catch(Re){console.error("Error parsing pending purchase:",Re),O.error("Invalid purchase data"),D("/")}else O.error("Payment verification failed. Please contact support."),D("/")}}else{console.log("⚠️ No payment reference found in URL"),console.log("🔍 Checking localStorage for saved purchase...");const Se=localStorage.getItem("recent_purchase");if(Se)try{const ie=JSON.parse(Se);console.log("📂 Found saved purchase:",ie),h(ie.purchase),N(ie.accessCode),j(ie.currency||"NGN"),Z(ie.paymentMethod||"paystack"),O.success("Welcome back! Your access code is ready.")}catch(ie){console.error("Error parsing saved purchase:",ie),O.error("No valid purchase found"),D("/")}else console.log("❌ No saved purchase found in localStorage"),O.error("No purchase found. Please make a purchase first."),D("/")}}catch(We){console.error("🔥 Payment verification error:",We),O.error("Error verifying payment. Please contact support."),D("/")}finally{A(!1)}})()},[z,D]),b.useEffect(()=>{(()=>{try{const H=localStorage.getItem("user");if(H){const fe=JSON.parse(H);B(fe),fe.email&&n(fe.email),fe.name&&o(fe.name)}const oe=localStorage.getItem("guest_email");oe&&!t&&n(oe)}catch(H){console.error("Error initializing user:",H)}})()},[]);const G=($,H)=>{if(!$){O.error("Nothing to copy");return}navigator.clipboard.writeText($).then(()=>{H==="code"?(g(!0),setTimeout(()=>g(!1),2e3)):(y(!0),setTimeout(()=>y(!1),2e3)),O.success("Copied to clipboard!")}).catch(oe=>{console.error("Failed to copy:",oe),O.error("Failed to copy to clipboard")})},V=async()=>{if(!t){O.error("Please enter your email address");return}if(!t.includes("@")){O.error("Please enter a valid email address");return}d(!0);try{console.log("🔗 Generating affiliate link for:",t),console.log("📧 With name:",a);const $=await De.registerAffiliate(t,a);if(console.log("📝 Registration result:",$),!$.success){O.error($.error||"Failed to register as affiliate"),d(!1);return}if($.affiliate){const H=$.affiliate.link;u(H),we($.affiliate.code),i(!0),localStorage.setItem("affiliate_info",JSON.stringify({affiliateCode:$.affiliate.code,email:t,name:a,link:H,generatedAt:new Date().toISOString()})),O.success("🎉 Affiliate link generated! Check your email for dashboard access."),setTimeout(()=>{const oe=document.getElementById("affiliate-link-section");oe&&oe.scrollIntoView({behavior:"smooth",block:"start"})},300)}else{const H=Date.now(),oe=Math.random().toString(36).substr(2,8).toUpperCase(),fe=`AFF${H.toString(36).toUpperCase()}${oe}`,We=De.generateShareLink(fe);u(We),i(!0),O.success("Affiliate link generated!")}}catch($){console.error("Affiliate generation error:",$),O.error("Failed to generate affiliate link. Please try again.")}finally{d(!1)}},ge=$=>($*ae).toLocaleString("en-NG",{style:"currency",currency:"NGN",minimumFractionDigits:0,maximumFractionDigits:0}).replace("NGN","₦"),Ie=()=>f?U==="USD"?`$${f.amount?(f.amount/100).toFixed(2):"5.00"}`:`₦${(f.amount||2500).toLocaleString()}`:"",Ve=()=>X==="stripe"?"Stripe (Credit/Debit Card)":"Paystack";b.useEffect(()=>{console.log("🍪 All cookies:",document.cookie),console.log("🍪 affiliate_ref:",document.cookie.replace(/(?:(?:^|.*;\s*)affiliate_ref\s*\=\s*([^;]*).*$)|^.*$/,"$1"))},[]);const Be=()=>{var $;if(!p){O.error("Access code not available");return}try{localStorage.setItem("ebook_access_suicide-note-2026",p),localStorage.setItem("last_ebook_accessed","suicide-note-2026"),localStorage.setItem("last_access_time",new Date().toISOString()),console.log("📚 Starting reading with access code:",p),D("/read/suicide-note-2026",{state:{accessCode:p,purchaseId:f==null?void 0:f._id,ebookTitle:(($=f==null?void 0:f.ebook)==null?void 0:$.title)||"Suicide Note",currency:U}})}catch(H){console.error("Error starting reading:",H),O.error("Error accessing book. Please try again.")}},F=()=>{e?e():D("/")};return C?s.createElement("div",{className:w.loadingContainer},s.createElement("div",{className:w.spinner}),s.createElement("p",null,"Verifying your payment...")):s.createElement("div",{className:w.container},s.createElement("div",{className:w.header},s.createElement("div",{className:"container"},s.createElement("div",{className:w.headerContent},s.createElement("div",{className:w.logo},s.createElement(W,{name:"Book",className:w.logoIcon}),s.createElement("span",{className:w.logoText},"Suicide Note")),s.createElement("button",{onClick:F,className:w.backButton,disabled:C},"← Back to Home")))),s.createElement("div",{className:"container"},s.createElement("div",{className:w.mainContent},s.createElement("div",{className:`card ${w.successCard}`},s.createElement("div",{className:w.successHeader},s.createElement("div",{className:w.successCheck},s.createElement(W,{name:"Check",className:w.checkIcon})),s.createElement("h1",{className:w.successTitle},"🎉 Payment Successful!"),s.createElement("p",{className:w.successSubtitle},"Thank you for purchasing Suicide Note. Your access code is ready."),f&&s.createElement("div",{className:w.purchaseInfo},s.createElement("p",null,"Purchase ID: ",s.createElement("span",{className:w.purchaseId},(q=f._id)==null?void 0:q.substring(0,8),"...")),s.createElement("p",null,"Amount: ",s.createElement("span",{className:w.purchaseAmount},Ie())),s.createElement("p",null,"Payment Method: ",s.createElement("span",{className:w.paymentMethod},Ve())))),s.createElement("div",{className:w.accessSection},s.createElement("div",{className:w.accessCard},s.createElement("h2",{className:w.accessTitle},"Your Access Code"),s.createElement("div",{className:w.codeDisplay},s.createElement("code",{className:w.codeText},p),s.createElement("button",{onClick:()=>G(p,"code"),className:w.copyButton,disabled:!p||m},s.createElement(W,{name:"Copy",className:w.copyIcon}),s.createElement("span",null,m?"Copied!":"Copy"))),s.createElement("div",{className:"text-center"},s.createElement("button",{onClick:Be,className:`btn btn-blue ${w.startReadingButton}`,disabled:!p||C},s.createElement(W,{name:"Book",className:w.bookIcon}),s.createElement("span",null,C?"Loading...":"Start Reading Now"),s.createElement(W,{name:"ArrowRight",className:w.arrowIcon})),s.createElement("p",{className:w.codeNote},"Click above to access your book or enter your code on the main page"))),s.createElement("div",{className:"warning-box"},s.createElement("p",{className:w.warningText},s.createElement("strong",null,"📧 Important:")," We've also sent this access code to your email. Save it somewhere safe - you'll need it to read the book anytime.")))),U==="NGN"&&s.createElement("div",{className:w.affiliateCard},s.createElement("div",{className:w.affiliateContent},s.createElement("div",{className:"text-center mb-8"},s.createElement("span",{className:"badge badge-yellow animate-pulse mb-4"},"⚡ WAIT! ONE MORE THING..."),s.createElement("h2",{className:w.affiliateTitle},"Want to Earn Your Money Back?"),s.createElement("p",{className:w.affiliateSubtitle},"You just invested ₦",(f==null?void 0:f.amount)||2500,". What if you could earn that back (and more) just by sharing this book?")),s.createElement("div",{className:w.valueProposition},s.createElement("div",{className:w.valueContent},s.createElement("div",null,s.createElement("h3",{className:w.valueTitle},"Here's the Deal:"),s.createElement("ul",{className:w.valueList},s.createElement("li",{className:w.valueItem},s.createElement("div",{className:w.checkCircle},s.createElement(W,{name:"Check",className:w.smallCheckIcon})),s.createElement("span",null,"Get your unique affiliate link instantly")),s.createElement("li",{className:w.valueItem},s.createElement("div",{className:w.checkCircle},s.createElement(W,{name:"Check",className:w.smallCheckIcon})),s.createElement("span",null,"Share on Twitter, WhatsApp, Facebook, Instagram")),s.createElement("li",{className:w.valueItem},s.createElement("div",{className:w.checkCircle},s.createElement(W,{name:"Check",className:w.smallCheckIcon})),s.createElement("span",null,"Earn ",s.createElement("strong",{className:w.highlightGreen},"₦",ae," (50%)")," per sale")),s.createElement("li",{className:w.valueItem},s.createElement("div",{className:w.checkCircle},s.createElement(W,{name:"Check",className:w.smallCheckIcon})),s.createElement("span",null,"Get paid automatically via Paystack in 7 days")),s.createElement("li",{className:w.valueItem},s.createElement("div",{className:w.checkCircle},s.createElement(W,{name:"Check",className:w.smallCheckIcon})),s.createElement("span",null,"No approval needed - start immediately")))),s.createElement("div",{className:w.earningsCard},s.createElement("h3",{className:w.earningsTitle},"💰 Your Earning Potential"),s.createElement("div",{className:w.earningsList},s.createElement("div",{className:w.earningItem},s.createElement("div",{className:w.earningHeader},s.createElement("span",{className:w.earningLabel},"Just 2 sales:"),s.createElement("span",{className:w.earningAmount},"₦",(ae*2).toLocaleString())),s.createElement("p",{className:w.earningNote},"Your money back!")),s.createElement("div",{className:w.earningItem},s.createElement("div",{className:w.earningHeader},s.createElement("span",{className:w.earningLabel},"20 sales:"),s.createElement("span",{className:w.earningAmount},"₦",(ae*20).toLocaleString())),s.createElement("p",{className:w.earningNote},"One good Twitter thread")),s.createElement("div",{className:w.earningItem},s.createElement("div",{className:w.earningHeader},s.createElement("span",{className:w.earningLabel},"50 sales:"),s.createElement("span",{className:w.earningAmount},"₦",(ae*50).toLocaleString())),s.createElement("p",{className:w.earningNote},"Consistent sharing")),s.createElement("div",{className:w.premiumEarning},s.createElement("div",{className:w.earningHeader},s.createElement("span",{className:w.premiumLabel},"100 sales:"),s.createElement("span",{className:w.premiumAmount},"₦",(ae*100).toLocaleString())),s.createElement("p",{className:w.premiumNote},"Our top affiliate last month!")))))),s.createElement("div",{className:w.socialProof},s.createElement("div",{className:w.socialContent},s.createElement("div",{className:w.socialAvatar},"T"),s.createElement("div",null,s.createElement("p",{className:w.socialText},`"I've earned `,s.createElement("span",{className:w.highlightYellow},"₦",(ae*37.6).toLocaleString()," in just 2 months"),' by sharing this book on Twitter. I posted one thread about my mental health journey and how this book helped me. The book basically paid for itself after 2 sales, everything else is pure profit!"'),s.createElement("p",{className:w.socialAuthor},"- Tunde O., Lagos"),s.createElement("div",{className:w.socialStats},s.createElement("span",null,"✓ 38 sales"),s.createElement("span",null,"✓ ₦",(ae*38).toLocaleString()," earned"),s.createElement("span",null,"✓ Started 2 months ago"))))),s.createElement("div",{className:"card mb-8"},s.createElement("h3",{className:w.calculatorTitle},"Calculate Your Potential Earnings"),s.createElement("div",{className:w.calculatorContent},s.createElement("label",{className:w.sliderLabel},"How many sales do you think you can make per month?"),s.createElement("div",{className:w.sliderContainer},s.createElement("input",{type:"range",min:"5",max:"100",step:"5",value:k,onChange:$=>E(Number($.target.value)),className:w.slider,disabled:c}),s.createElement("div",{className:w.sliderLabels},s.createElement("span",null,"5 sales"),s.createElement("span",null,"100 sales"))),s.createElement("div",{className:w.earningsDisplay},s.createElement("div",{className:w.earningsAmount},ge(k)),s.createElement("p",{className:w.earningsText},"per month with ",k," sales"),s.createElement("p",{className:w.yearlyEarnings},"That's ",ge(k*12)," per year!")))),s.createElement("div",{className:"card"},s.createElement("h3",{className:w.formTitle},"Get Your Affiliate Link Now (Takes 30 Seconds)"),r?s.createElement("div",{id:"generated-link",className:w.generatedLinkSection},s.createElement("div",{className:w.successMessage},s.createElement(W,{name:"Check",className:w.bigCheckIcon}),s.createElement("h3",{className:w.successHeading},"Success! Your Link is Ready"),s.createElement("p",{className:w.successText},"Start sharing and earning right now!")),s.createElement("div",{className:w.linkContainer},s.createElement("label",{className:w.linkLabel},"Your Unique Affiliate Link:"),s.createElement("div",{className:w.linkDisplay},s.createElement("code",{className:w.linkCode},l),s.createElement("button",{onClick:()=>G(l,"link"),className:w.copyLinkButton,disabled:S},s.createElement(W,{name:"Copy",className:w.copyIcon}),s.createElement("span",null,S?"Copied!":"Copy")))),s.createElement("div",{className:w.socialShareSection},s.createElement("h4",{className:w.shareTitle},"📱 Share Your Link Now:"),s.createElement("div",{className:w.socialShareButtons},s.createElement("a",{href:`https://twitter.com/intent/tweet?text=${encodeURIComponent(`I just earned my money back from this powerful book about mental health in Nigeria. Join me as an affiliate and earn ₦${ae} per sale!`)}&url=${encodeURIComponent(l)}`,target:"_blank",rel:"noopener noreferrer",className:w.twitterShareButton},s.createElement(W,{name:"Twitter"})," Twitter"),s.createElement("a",{href:`https://wa.me/?text=${encodeURIComponent(`I just earned my money back from this powerful book about mental health in Nigeria. Get your affiliate link and earn ₦${ae} per sale! ${l}`)}`,target:"_blank",rel:"noopener noreferrer",className:w.whatsappShareButton},s.createElement(W,{name:"MessageCircle"})," WhatsApp"),s.createElement("a",{href:`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent(l)}`,target:"_blank",rel:"noopener noreferrer",className:w.facebookShareButton},s.createElement(W,{name:"Facebook"})," Facebook"))),s.createElement("div",{className:w.sharingGuide},s.createElement("h4",{className:w.guideTitle},"📱 How to Share Your Link:"),s.createElement("div",{className:w.socialGrid},s.createElement("div",{className:w.socialItem},s.createElement(W,{name:"Twitter",className:w.twitterIcon}),s.createElement("div",null,s.createElement("p",{className:w.socialName},"Twitter/X"),s.createElement("p",{className:w.socialDescription},"Share your story + link in a thread"))),s.createElement("div",{className:w.socialItem},s.createElement(W,{name:"MessageCircle",className:w.whatsappIcon}),s.createElement("div",null,s.createElement("p",{className:w.socialName},"WhatsApp Status"),s.createElement("p",{className:w.socialDescription},"Post to your status with link"))),s.createElement("div",{className:w.socialItem},s.createElement(W,{name:"Share2",className:w.facebookIcon}),s.createElement("div",null,s.createElement("p",{className:w.socialName},"Facebook"),s.createElement("p",{className:w.socialDescription},"Share in groups or your timeline"))),s.createElement("div",{className:w.socialItem},s.createElement(W,{name:"Mail",className:w.emailIcon}),s.createElement("div",null,s.createElement("p",{className:w.socialName},"Email"),s.createElement("p",{className:w.socialDescription},"Send to friends and family"))))),s.createElement("div",{className:"pro-tip"},s.createElement("p",{className:w.tipText},s.createElement("strong",null,"💡 Pro Tip:")," The more personal your recommendation, the better! Share how this book helped YOU with mental health awareness. Authentic stories sell better than generic promotions.")),s.createElement("div",{className:w.emailConfirmation},s.createElement("p",{className:w.confirmationText},s.createElement("strong",null,"We've emailed your affiliate link to:"),s.createElement("br",null),s.createElement("span",{className:w.userEmail},t)),s.createElement("p",{className:w.confirmationNote},"Track your earnings, get payment updates, and access promotional materials via email."))):s.createElement("div",null,s.createElement("div",{className:w.signupForm},s.createElement("input",{type:"text",placeholder:"Your name (optional)",value:a,onChange:$=>o($.target.value),className:`form-input ${w.nameInput}`,disabled:c}),s.createElement("input",{type:"email",placeholder:"Enter your email address *",value:t,onChange:$=>n($.target.value),className:`form-input ${w.emailInput}`,disabled:c,required:!0}),s.createElement("button",{onClick:V,className:`btn btn-green ${w.generateButton}`,disabled:c||!t||!t.includes("@")},c?s.createElement(s.Fragment,null,s.createElement("span",{className:"spinner-sm mr-2"}),"Processing..."):s.createElement(s.Fragment,null,s.createElement(W,{name:"DollarSign",className:w.dollarIcon}),s.createElement("span",null,"Generate My Affiliate Link"),s.createElement(W,{name:"ArrowRight",className:w.arrowIcon}))),s.createElement("p",{className:w.formNote},"No approval needed. Start earning immediately.")),s.createElement("div",{className:w.statsGrid},s.createElement("div",{className:w.statCard},s.createElement(W,{name:"Users",className:w.statIcon}),s.createElement("p",{className:w.statText},"143 Active Affiliates")),s.createElement("div",{className:w.statCard},s.createElement(W,{name:"TrendingUp",className:w.statIcon}),s.createElement("p",{className:w.statText},"₦2.4M Paid Out")),s.createElement("div",{className:w.statCard},s.createElement(W,{name:"Check",className:w.statIcon}),s.createElement("p",{className:w.statText},"7-Day Payouts"))))))),U==="USD"&&s.createElement("div",{className:w.internationalCard},s.createElement("div",{className:w.internationalContent},s.createElement("div",{className:"text-center mb-8"},s.createElement("span",{className:"badge badge-blue animate-pulse mb-4"},"🌍 INTERNATIONAL PURCHASE"),s.createElement("h2",{className:w.internationalTitle},"Thank You for Your Support!"),s.createElement("p",{className:w.internationalSubtitle},"Your purchase helps bring important conversations about mental health to a global audience.")),s.createElement("div",{className:w.internationalMessage},s.createElement(W,{name:"Globe",className:w.globeIcon}),s.createElement("div",null,s.createElement("h3",{className:w.internationalMessageTitle},"You now have full access to the book"),s.createElement("p",{className:w.internationalMessageText},'Your access code above will give you unlimited access to "Suicide Note" by Loba Yusuf. You can read online anytime, anywhere in the world.'))),s.createElement("div",{className:w.internationalFeatures},s.createElement("div",{className:w.feature},s.createElement(W,{name:"CheckCircle",className:w.featureCheckIcon}),s.createElement("span",null,"Full book access")),s.createElement("div",{className:w.feature},s.createElement(W,{name:"CheckCircle",className:w.featureCheckIcon}),s.createElement("span",null,"Read online anytime")),s.createElement("div",{className:w.feature},s.createElement(W,{name:"CheckCircle",className:w.featureCheckIcon}),s.createElement("span",null,"No expiration")),s.createElement("div",{className:w.feature},s.createElement(W,{name:"CheckCircle",className:w.featureCheckIcon}),s.createElement("span",null,"Support mental health awareness"))))),U==="NGN"&&s.createElement("div",{className:"card mb-8"},s.createElement("h2",{className:w.whyTitle},"Why Our Affiliates Succeed"),s.createElement("div",{className:w.whyGrid},s.createElement("div",{className:w.whyCard},s.createElement("div",{className:w.whyIcon},s.createElement(W,{name:"Book",className:w.purpleIcon})),s.createElement("h3",{className:w.whyCardTitle},"Powerful Product"),s.createElement("p",{className:w.whyCardText},"This book changes lives. When you share it, you're genuinely helping people - not just selling.")),s.createElement("div",{className:w.whyCard},s.createElement("div",{className:w.whyIcon},s.createElement(W,{name:"DollarSign",className:w.blueIcon})),s.createElement("h3",{className:w.whyCardTitle},"50% Commission"),s.createElement("p",{className:w.whyCardText},"Most Nigerian ebooks offer 20-30%. We offer 50% because we want you motivated to share.")),s.createElement("div",{className:w.whyCard},s.createElement("div",{className:w.whyIcon},s.createElement(W,{name:"TrendingUp",className:w.greenIcon})),s.createElement("h3",{className:w.whyCardTitle},"Easy to Promote"),s.createElement("p",{className:w.whyCardText},"Mental health is trending. People want this content. One good post can get you 20+ sales.")))),s.createElement("div",{className:w.finalCTA},s.createElement("h3",{className:w.finalTitle},"Ready to Start Reading?"),s.createElement("p",{className:w.finalSubtitle},"Your access code is ready. Click below to begin your journey with Eliora's story."),s.createElement("button",{onClick:Be,className:`btn btn-blue ${w.readingButton}`,disabled:!p||C},s.createElement(W,{name:"Book",className:w.bookIcon}),s.createElement("span",null,"Start Reading Now"))))),s.createElement("footer",{className:w.footer},s.createElement("div",{className:"container"},s.createElement("div",{className:w.footerContent},s.createElement("p",{className:w.footerText},"Questions? Email us at support@suicidenote.com"),s.createElement("p",{className:w.copyright},"© 2026 Loba Yusuf. All rights reserved.")))))},qt=[{page:1,chapter:"Cover",content:`SUICIDE NOTE
by Loba Yusuf
...
Loba Yusuf`,wordCount:60}],ME=qt.reduce((e,t)=>e+(t.wordCount||0),0),Dn=qt.length,OE=Math.ceil(ME/200),DE=()=>{const e=new Set;return qt.filter(t=>e.has(t.chapter)?!1:(e.add(t.chapter),!0)).map(t=>({chapter:t.chapter,page:t.page}))},Es={validateAccessCode:async(e,t)=>new Promise(n=>{setTimeout(()=>{e&&e.startsWith("SN-")?n({success:!0}):n({success:!1})},500)}),verifyPayment:async e=>new Promise(t=>{setTimeout(()=>{t({success:!0,data:{accessCode:`SN-${Date.now().toString(36).toUpperCase()}-${Math.random().toString(36).substr(2,6).toUpperCase()}`}})},500)})},FE=()=>{const{ebookId:e="suicide-note-2026"}=Ph(),t=pa(),n=Mn(),a=14,o=24,[r,i]=b.useState(()=>{const R=localStorage.getItem("rdr_fontSize");return R?parseInt(R):16}),[l,u]=b.useState(4),[c,d]=b.useState(!1),[m,g]=b.useState("Chapter One: The Note Begins"),[S,y]=b.useState(""),[k,E]=b.useState(!1),[f,h]=b.useState(!0),[p,N]=b.useState(null),C=DE();b.useEffect(()=>{(async()=>{var z;const ee=new URLSearchParams(n.search),ae=ee.get("accessCode"),x=ee.get("reference");try{h(!0);const D=localStorage.getItem(`ebook_access_${e}`);if(D)if((await Es.validateAccessCode(D,e)).success){y(D),E(!0);const V=localStorage.getItem(`bookmark_${e}`);if(V){const ge=parseInt(V);ge>0&&ge<=qt.length&&(u(ge),g(qt[ge-1].chapter))}h(!1);return}else{localStorage.removeItem(`ebook_access_${e}`),h(!1);return}if(ae)(await Es.validateAccessCode(ae,e)).success&&(y(ae),E(!0),localStorage.setItem(`ebook_access_${e}`,ae));else if(x){const G=await Es.verifyPayment(x);if(G.success){const V=((z=G.data)==null?void 0:z.accessCode)||`SN-${Date.now().toString(36).toUpperCase()}-${Math.random().toString(36).substr(2,6).toUpperCase()}`;y(V),E(!0),localStorage.setItem(`ebook_access_${e}`,V)}}}catch(D){console.error("Reader initialization error:",D)}finally{h(!1)}})()},[e,n.search]),b.useEffect(()=>{k&&l&&(localStorage.setItem(`bookmark_${e}`,l.toString()),N(l))},[l,e,k]),b.useEffect(()=>{localStorage.setItem("rdr_fontSize",r),document.documentElement.style.setProperty("--font-size",`${r}px`)},[r]),b.useEffect(()=>{const R=qt.find(ee=>ee.page===l);R&&g(R.chapter)},[l]);const A=R=>R.split(`

`).map((ae,x)=>{const z=ae.trim();if(!z)return null;const D=z.split(`
`);return D.length>1?D.map((G,V)=>G.trim()?s.createElement("p",{key:`${x}-${V}`},G.trim()):null):s.createElement("p",{key:x},z)}),P=()=>{r>a&&i(R=>R-1)},B=()=>{r<o&&i(R=>R+1)},U=()=>{d(!c)},j=(R,ee)=>{u(ee),d(!1),window.scrollTo({top:0,behavior:"smooth"})},X=()=>{l>1&&(u(R=>R-1),window.scrollTo({top:0,behavior:"smooth"}))},Z=()=>{l<Dn&&(u(R=>R+1),window.scrollTo({top:0,behavior:"smooth"}))};b.useEffect(()=>{const R=ee=>{k&&(ee.key==="ArrowLeft"&&!ee.ctrlKey&&!ee.metaKey?X():ee.key==="ArrowRight"&&!ee.ctrlKey&&!ee.metaKey&&Z())};return document.addEventListener("keydown",R),()=>document.removeEventListener("keydown",R)},[k,l]);const ne=l/Dn*100,we=qt.find(R=>R.page===l)||qt[3];return f?s.createElement("div",{className:"loading-container"},s.createElement("div",{className:"spinner"}),s.createElement("p",null,"Loading your book...")):k?s.createElement("div",{className:"reader-page"},s.createElement("header",{className:"header"},s.createElement("button",{className:"header-back",onClick:()=>t("/")},s.createElement("svg",{width:"9",height:"15",viewBox:"0 0 9 15",fill:"none","aria-hidden":"true"},s.createElement("path",{d:"M8 1L1 7.5L8 14",stroke:"currentColor",strokeWidth:"1.8",strokeLinecap:"round",strokeLinejoin:"round"})),"Back"),s.createElement("div",{className:"header-center"},s.createElement("div",{className:"header-title"},"Suicide Note"),s.createElement("div",{className:"header-author"},"by Loba Yusuf")),s.createElement("div",{className:"font-controls",role:"group","aria-label":"Font size controls"},s.createElement("button",{className:"font-btn",onClick:P,disabled:r<=a,"aria-label":"Decrease font size"},"−"),s.createElement("span",{className:"font-size-label"},r,"px"),s.createElement("button",{className:"font-btn",onClick:B,disabled:r>=o,"aria-label":"Increase font size"},"+"))),s.createElement("div",{className:"progress-bar-wrap",role:"progressbar","aria-valuenow":l,"aria-valuemin":"1","aria-valuemax":Dn,"aria-label":"Reading progress"},s.createElement("div",{className:"progress-bar-fill",style:{width:`${ne}%`}})),s.createElement("div",{className:"chapter-toggle-wrap"},s.createElement("button",{className:"chapter-toggle-btn",onClick:U,"aria-expanded":c,"aria-controls":"chapterList"},s.createElement("span",{className:"chapter-toggle-icon"},"📖"),s.createElement("span",{className:"chapter-toggle-label"},m),s.createElement("span",{className:`chapter-chevron ${c?"open":""}`,"aria-hidden":"true"},"⌄")),s.createElement("div",{className:`chapter-list ${c?"open":""}`,id:"chapterList",role:"list"},C.map((R,ee)=>s.createElement("button",{key:ee,className:`chapter-item ${R.chapter===m?"current":""}`,role:"listitem",onClick:()=>j(R.chapter,R.page)},R.chapter)))),s.createElement("main",{className:"reading-area"},s.createElement("article",{className:"reading-text"},A(we.content))),s.createElement("nav",{className:"page-nav","aria-label":"Page navigation"},s.createElement("button",{className:"nav-btn",onClick:X,disabled:l<=1,"aria-label":"Previous page"},"Previous"),s.createElement("div",{className:"page-indicator","aria-live":"polite"},"Page ",l," of ",Dn),s.createElement("button",{className:"nav-btn",onClick:Z,disabled:l>=Dn,"aria-label":"Next page"},"Next →")),s.createElement("footer",{className:"site-footer"},s.createElement("div",{className:"footer-section"},s.createElement("div",{className:"footer-label"},"Your Access Code"),s.createElement("div",{className:"footer-code"},S)),s.createElement("div",{className:"footer-section"},s.createElement("div",{className:"footer-distress"},"If you're experiencing emotional distress:"),s.createElement("div",{className:"footer-emergency"},"🇳🇬 Nigeria Emergency: ",s.createElement("strong",null,"112")),s.createElement("div",{className:"footer-emergency"},"🏙️ Lagos Emergency: ",s.createElement("strong",null,"767"))),s.createElement("div",{className:"footer-section"},s.createElement("div",{className:"footer-label"},"Follow the Author"),s.createElement("div",{className:"footer-social-row"},s.createElement("span",{className:"social-icon fb","aria-hidden":"true"},"f"),s.createElement("a",{href:"https://facebook.com/olorunloba.yusuf",className:"footer-link",target:"_blank",rel:"noopener"},"olorunloba.yusuf")),s.createElement("div",{className:"footer-social-row"},s.createElement("span",{className:"social-icon ig","aria-hidden":"true"},"ig"),s.createElement("a",{href:"https://instagram.com/loba_yusuf",className:"footer-link",target:"_blank",rel:"noopener"},"@loba_yusuf")),s.createElement("div",{className:"footer-social-row"},s.createElement("span",{className:"social-icon tw","aria-hidden":"true"},"𝕏"),s.createElement("a",{href:"https://twitter.com/loba_yusuf",className:"footer-link",target:"_blank",rel:"noopener"},"@loba_yusuf"))),s.createElement("div",{className:"footer-meta"},"Reading time: ~",OE," min  ·  ",Dn," pages total"))):s.createElement("div",{className:"access-denied"},s.createElement("h2",null,"Access Denied"),s.createElement("p",null,"Please purchase the book to read the full content."),s.createElement("button",{onClick:()=>t("/"),className:"home-btn"},"Go to Homepage"))},jE=()=>{const{token:e}=Ph(),t=pa();return b.useEffect(()=>{(async()=>{var a,o,r;if(console.log("🔍 Token from URL params:",e),console.log("🔍 Full URL:",window.location.href),!e||e==="undefined"||e.trim()===""){console.error("❌ No valid token provided in URL"),O.error("Invalid dashboard link: No token provided"),setTimeout(()=>{t("/")},3e3);return}try{console.log("🔍 Validating token:",e);const i=await K.get(`/api/v1/affiliate/token/validate/${e}`);console.log("✅ Validation response:",i.data),i.data.success?(localStorage.setItem("affiliate_token",e),t(`/affiliate/dashboard?token=${e}`)):(O.error("Invalid or expired dashboard link"),setTimeout(()=>{t("/")},2e3))}catch(i){console.error("❌ Token validation error:",i),console.error("Error response:",(a=i.response)==null?void 0:a.data),O.error(((r=(o=i.response)==null?void 0:o.data)==null?void 0:r.error)||"Invalid or expired dashboard link"),setTimeout(()=>{t("/")},2e3)}})()},[e,t]),s.createElement("div",{style:{display:"flex",justifyContent:"center",alignItems:"center",height:"100vh",flexDirection:"column",backgroundColor:"#f9f9f9"}},s.createElement("div",{style:{width:"50px",height:"50px",border:"4px solid #e0e0e0",borderTop:"4px solid #059669",borderRadius:"50%",animation:"spin 1s linear infinite",marginBottom:"20px"}}),s.createElement("p",{style:{color:"#333",fontSize:"16px"}},e&&e!=="undefined"?"Validating your dashboard access...":"Invalid dashboard link..."),s.createElement("style",null,`
        @keyframes spin {
          0% { transform: rotate(0deg); }
          100% { transform: rotate(360deg); }
        }
      `))},zE="_container_18f2y_3",WE="_loadingContainer_18f2y_15",UE="_spinner_18f2y_33",$E="_header_18f2y_215",HE="_headerContent_18f2y_233",YE="_title_18f2y_245",GE="_headerStats_18f2y_259",VE="_headerStat_18f2y_259",qE="_headerStatLabel_18f2y_279",JE="_headerStatValue_18f2y_291",KE="_tabs_18f2y_305",QE="_tab_18f2y_305",XE="_activeTab_18f2y_355",ZE="_tabContent_18f2y_385",e0="_tabTitle_18f2y_397",t0="_overview_18f2y_413",n0="_linkCard_18f2y_423",a0="_linkCardTitle_18f2y_437",o0="_linkDisplay_18f2y_451",r0="_linkCode_18f2y_463",s0="_copyButton_18f2y_485",i0="_linkNote_18f2y_521",l0="_statsGrid_18f2y_531",u0="_statCard_18f2y_543",c0="_statIcon_18f2y_563",d0="_statInfo_18f2y_571",h0="_statLabel_18f2y_581",m0="_statValue_18f2y_593",f0="_recentSection_18f2y_607",p0="_sectionTitle_18f2y_635",g0="_referralsList_18f2y_665",y0="_referralItem_18f2y_675",w0="_referralInfo_18f2y_693",v0="_referralName_18f2y_705",k0="_referralEbook_18f2y_715",I0="_referralMeta_18f2y_725",b0="_referralAmount_18f2y_737",E0="_referralCommission_18f2y_745",S0="_referralDate_18f2y_755",_0="_campaigns_18f2y_767",N0="_campaignsHeader_18f2y_781",C0="_createButton_18f2y_795",T0="_campaignsGrid_18f2y_831",x0="_campaignCard_18f2y_843",A0="_campaignName_18f2y_855",P0="_campaignStats_18f2y_869",L0="_campaignStat_18f2y_869",B0="_campaignStatLabel_18f2y_893",R0="_campaignStatValue_18f2y_905",M0="_campaignLink_18f2y_917",O0="_campaignLinkCode_18f2y_937",D0="_copySmallButton_18f2y_953",F0="_campaignCreated_18f2y_969",j0="_referrals_18f2y_665",z0="_referralsTable_18f2y_995",W0="_referralsHeader_18f2y_1005",U0="_referralRow_18f2y_1027",$0="_referralCell_18f2y_1047",H0="_referralCellLabel_18f2y_1057",Y0="_commissionAmount_18f2y_1071",G0="_emptyState_18f2y_1229",V0="_emptyStateSub_18f2y_1241",q0="_emptyStateButton_18f2y_1251",J0="_payouts_18f2y_1273",K0="_payoutsGrid_18f2y_1287",Q0="_bankDetailsCard_18f2y_1299",X0="_payoutCard_18f2y_1299",Z0="_cardTitle_18f2y_1311",eS="_formGroup_18f2y_1325",tS="_formRow_18f2y_1381",nS="_bankDetails_18f2y_1299",aS="_bankDetail_18f2y_1299",oS="_bankDetailLabel_18f2y_1419",rS="_bankDetailValue_18f2y_1427",sS="_saveButton_18f2y_1437",iS="_payoutButton_18f2y_1437",lS="_editButton_18f2y_1471",uS="_earningsSummary_18f2y_1491",cS="_earningRow_18f2y_1505",dS="_earningAmount_18f2y_1527",hS="_payoutForm_18f2y_1537",mS="_payoutNote_18f2y_1545",fS="_bankRequired_18f2y_1559",pS="_modalOverlay_18f2y_1577",gS="_modal_18f2y_1577",yS="_modalHeader_18f2y_1621",wS="_modalTitle_18f2y_1637",vS="_modalClose_18f2y_1649",kS="_modalBody_18f2y_1665",IS="_modalFooter_18f2y_1673",bS="_cancelButton_18f2y_1689",I={container:zE,loadingContainer:WE,spinner:UE,header:$E,headerContent:HE,title:YE,headerStats:GE,headerStat:VE,headerStatLabel:qE,headerStatValue:JE,tabs:KE,tab:QE,activeTab:XE,tabContent:ZE,tabTitle:e0,overview:t0,linkCard:n0,linkCardTitle:a0,linkDisplay:o0,linkCode:r0,copyButton:s0,linkNote:i0,statsGrid:l0,statCard:u0,statIcon:c0,statInfo:d0,statLabel:h0,statValue:m0,recentSection:f0,sectionTitle:p0,referralsList:g0,referralItem:y0,referralInfo:w0,referralName:v0,referralEbook:k0,referralMeta:I0,referralAmount:b0,referralCommission:E0,referralDate:S0,campaigns:_0,campaignsHeader:N0,createButton:C0,campaignsGrid:T0,campaignCard:x0,campaignName:A0,campaignStats:P0,campaignStat:L0,campaignStatLabel:B0,campaignStatValue:R0,campaignLink:M0,campaignLinkCode:O0,copySmallButton:D0,campaignCreated:F0,referrals:j0,referralsTable:z0,referralsHeader:W0,referralRow:U0,referralCell:$0,referralCellLabel:H0,commissionAmount:Y0,emptyState:G0,emptyStateSub:V0,emptyStateButton:q0,payouts:J0,payoutsGrid:K0,bankDetailsCard:Q0,payoutCard:X0,cardTitle:Z0,formGroup:eS,formRow:tS,bankDetails:nS,bankDetail:aS,bankDetailLabel:oS,bankDetailValue:rS,saveButton:sS,payoutButton:iS,editButton:lS,earningsSummary:uS,earningRow:cS,earningAmount:dS,payoutForm:hS,payoutNote:mS,bankRequired:fS,modalOverlay:pS,modal:gS,modalHeader:yS,modalTitle:wS,modalClose:vS,modalBody:kS,modalFooter:IS,cancelButton:bS},ES=()=>{var x,z,D,G,V,ge,Ie,Ve,Be,F,q,$,H,oe,fe,We;const[e]=Lg(),[t,n]=b.useState("overview"),[a,o]=b.useState(!0),[r,i]=b.useState(null),[l,u]=b.useState(null),[c,d]=b.useState([]),[m,g]=b.useState([]),[S,y]=b.useState({accountNumber:"",accountName:"",bankCode:"",bankName:""}),[k,E]=b.useState(!1),[f,h]=b.useState(!1),[p,N]=b.useState({name:"",description:"",medium:"",source:""}),[C,A]=b.useState(""),[P,B]=b.useState(""),[U,j]=b.useState("");b.useEffect(()=>{const L=e.get("token");if(!L){O.error("No access token provided"),setTimeout(()=>{window.location.href="/"},2e3);return}j(L),De.setAuthToken(L),X()},[e]);const X=async()=>{var L,it;o(!0);try{const[lt,xt,Se,ie,Re]=await Promise.all([De.getDashboard(),De.getEarnings(),De.getReferrals(1,20),De.getCampaigns(),De.getBankDetails()]);console.log("Dashboard response:",lt),console.log("Earnings response:",xt),console.log("Referrals response:",Se),Se.success&&((L=Se.data)!=null&&L.referrals)&&(console.log("🔍 First referral details:",Se.data.referrals[0]),console.log("🔍 All referrals:",Se.data.referrals)),lt.success&&i(lt.data),xt.success&&u(xt.data),Se.success&&d(Se.data.referrals||[]),ie.success&&g(ie.data),Re.success&&(y(Re.data.bankDetails||{}),E(Re.data.hasBankDetails||!1))}catch(lt){console.error("Error loading dashboard:",lt),O.error("Failed to load dashboard data"),((it=lt.response)==null?void 0:it.status)===401&&(O.error("Invalid or expired access link"),setTimeout(()=>{window.location.href="/"},2e3))}finally{o(!1)}},Z=async()=>{if(!p.name){O.error("Campaign name is required");return}o(!0);const L=await De.createCampaign(p);if(L.success){O.success("Campaign created successfully!"),h(!1),N({name:"",description:"",medium:"",source:""});const it=await De.getCampaigns();it.success&&g(it.data)}else O.error(L.error||"Failed to create campaign");o(!1)},ne=async()=>{if(!S.accountNumber||!S.accountName||!S.bankCode||!S.bankName){O.error("All bank details are required");return}o(!0);const L=await De.updateBankDetails(S);L.success?(O.success("Bank details updated successfully!"),E(!0)):O.error(L.error||"Failed to update bank details"),o(!1)},we=async()=>{if(!C||parseFloat(C)<=0){O.error("Please enter a valid amount");return}const L=parseFloat(C)*100;o(!0);const it=await De.requestPayout(L);if(it.success){O.success("Payout requested successfully!"),A("");const lt=await De.getEarnings();lt.success&&u(lt.data)}else O.error(it.error||"Failed to request payout");o(!1)},R=L=>{navigator.clipboard.writeText(L),B(L),O.success("Copied to clipboard!"),setTimeout(()=>B(""),2e3)},ee=L=>!L&&L!==0?"₦0":L,ae=L=>{if(!L)return"N/A";try{return new Date(L).toLocaleDateString("en-NG",{year:"numeric",month:"short",day:"numeric"})}catch{return"N/A"}};return a?s.createElement("div",{className:I.loadingContainer},s.createElement("div",{className:I.spinner}),s.createElement("p",null,"Loading your affiliate dashboard...")):s.createElement("div",{className:I.container},s.createElement("div",{className:I.header},s.createElement("div",{className:I.headerContent},s.createElement("h1",{className:I.title},"Affiliate Dashboard"),s.createElement("div",{className:I.headerStats},s.createElement("div",{className:I.headerStat},s.createElement("span",{className:I.headerStatLabel},"Total Earnings"),s.createElement("span",{className:I.headerStatValue},((x=r==null?void 0:r.earnings)==null?void 0:x.formattedTotal)||"₦0")),s.createElement("div",{className:I.headerStat},s.createElement("span",{className:I.headerStatLabel},"Pending"),s.createElement("span",{className:I.headerStatValue},((z=r==null?void 0:r.earnings)==null?void 0:z.formattedPending)||"₦0")),s.createElement("div",{className:I.headerStat},s.createElement("span",{className:I.headerStatLabel},"Referrals"),s.createElement("span",{className:I.headerStatValue},((D=r==null?void 0:r.stats)==null?void 0:D.totalReferrals)||0))))),s.createElement("div",{className:I.tabs},s.createElement("button",{className:`${I.tab} ${t==="overview"?I.activeTab:""}`,onClick:()=>n("overview")},"Overview"),s.createElement("button",{className:`${I.tab} ${t==="campaigns"?I.activeTab:""}`,onClick:()=>n("campaigns")},"Campaigns"),s.createElement("button",{className:`${I.tab} ${t==="referrals"?I.activeTab:""}`,onClick:()=>n("referrals")},"Referrals"),s.createElement("button",{className:`${I.tab} ${t==="payouts"?I.activeTab:""}`,onClick:()=>n("payouts")},"Payouts")),s.createElement("div",{className:I.tabContent},t==="overview"&&r&&s.createElement("div",{className:I.overview},s.createElement("div",{className:I.linkCard},s.createElement("h3",{className:I.linkCardTitle},"Your Affiliate Link"),s.createElement("div",{className:I.linkDisplay},s.createElement("code",{className:I.linkCode},(G=r.affiliate)==null?void 0:G.link),s.createElement("button",{onClick:()=>{var L;return R((L=r.affiliate)==null?void 0:L.link)},className:I.copyButton},s.createElement(W,{name:"Copy"}),s.createElement("span",null,"Copy"))),s.createElement("p",{className:I.linkNote},"Share this link to earn 50% commission on every sale!")),s.createElement("div",{className:I.statsGrid},s.createElement("div",{className:I.statCard},s.createElement("div",{className:I.statIcon},"💰"),s.createElement("div",{className:I.statInfo},s.createElement("span",{className:I.statLabel},"Total Earnings"),s.createElement("span",{className:I.statValue},(V=r.earnings)==null?void 0:V.formattedTotal))),s.createElement("div",{className:I.statCard},s.createElement("div",{className:I.statIcon},"⏳"),s.createElement("div",{className:I.statInfo},s.createElement("span",{className:I.statLabel},"Pending"),s.createElement("span",{className:I.statValue},(ge=r.earnings)==null?void 0:ge.formattedPending))),s.createElement("div",{className:I.statCard},s.createElement("div",{className:I.statIcon},"✅"),s.createElement("div",{className:I.statInfo},s.createElement("span",{className:I.statLabel},"Paid"),s.createElement("span",{className:I.statValue},(Ie=r.earnings)==null?void 0:Ie.formattedPaid))),s.createElement("div",{className:I.statCard},s.createElement("div",{className:I.statIcon},"👥"),s.createElement("div",{className:I.statInfo},s.createElement("span",{className:I.statLabel},"Total Clicks"),s.createElement("span",{className:I.statValue},((Ve=r.stats)==null?void 0:Ve.totalClicks)||0))),s.createElement("div",{className:I.statCard},s.createElement("div",{className:I.statIcon},"📊"),s.createElement("div",{className:I.statInfo},s.createElement("span",{className:I.statLabel},"Conversion Rate"),s.createElement("span",{className:I.statValue},((F=(Be=r.stats)==null?void 0:Be.conversionRate)==null?void 0:F.toFixed(1))||"0","%"))),s.createElement("div",{className:I.statCard},s.createElement("div",{className:I.statIcon},"📅"),s.createElement("div",{className:I.statInfo},s.createElement("span",{className:I.statLabel},"Joined"),s.createElement("span",{className:I.statValue},ae((q=r.affiliate)==null?void 0:q.createdAt))))),c.length>0&&s.createElement("div",{className:I.recentSection},s.createElement("h3",{className:I.sectionTitle},"Recent Referrals"),s.createElement("div",{className:I.referralsList},c.slice(0,5).map(L=>s.createElement("div",{key:L.id,className:I.referralItem},s.createElement("div",{className:I.referralInfo},s.createElement("span",{className:I.referralName},L.customer),s.createElement("span",{className:I.referralEbook},L.ebook)),s.createElement("div",{className:I.referralMeta},s.createElement("span",{className:I.referralAmount},L.amount),s.createElement("span",{className:I.referralCommission},"+",L.commission),s.createElement("span",{className:I.referralDate},ae(L.date)))))))),t==="campaigns"&&s.createElement("div",{className:I.campaigns},s.createElement("div",{className:I.campaignsHeader},s.createElement("h2",{className:I.tabTitle},"Your Campaigns"),s.createElement("button",{onClick:()=>h(!0),className:I.createButton},s.createElement(W,{name:"Plus"})," New Campaign")),m.length===0?s.createElement("div",{className:I.emptyState},s.createElement("p",null,"You haven't created any campaigns yet."),s.createElement("button",{onClick:()=>h(!0),className:I.emptyStateButton},"Create Your First Campaign")):s.createElement("div",{className:I.campaignsGrid},m.map(L=>s.createElement("div",{key:L.name,className:I.campaignCard},s.createElement("h3",{className:I.campaignName},L.name),s.createElement("div",{className:I.campaignStats},s.createElement("div",{className:I.campaignStat},s.createElement("span",{className:I.campaignStatLabel},"Clicks"),s.createElement("span",{className:I.campaignStatValue},L.clicks)),s.createElement("div",{className:I.campaignStat},s.createElement("span",{className:I.campaignStatLabel},"Conversions"),s.createElement("span",{className:I.campaignStatValue},L.conversions)),s.createElement("div",{className:I.campaignStat},s.createElement("span",{className:I.campaignStatLabel},"Conv. Rate"),s.createElement("span",{className:I.campaignStatValue},L.conversionRate,"%")),s.createElement("div",{className:I.campaignStat},s.createElement("span",{className:I.campaignStatLabel},"Earnings"),s.createElement("span",{className:I.campaignStatValue},ee(L.earnings)))),s.createElement("div",{className:I.campaignLink},s.createElement("code",{className:I.campaignLinkCode},L.link),s.createElement("button",{onClick:()=>R(L.link),className:I.copySmallButton},s.createElement(W,{name:"Copy"}))),s.createElement("p",{className:I.campaignCreated},"Created: ",ae(L.createdAt)))))),t==="referrals"&&s.createElement("div",{className:I.referrals},s.createElement("h2",{className:I.tabTitle},"Your Referrals"),c.length===0?s.createElement("div",{className:I.emptyState},s.createElement("p",null,"You haven't made any referrals yet."),s.createElement("p",{className:I.emptyStateSub},"Share your affiliate link to start earning!")):s.createElement("div",{className:I.referralsTable},s.createElement("div",{className:I.referralsHeader},s.createElement("span",null,"Customer"),s.createElement("span",null,"Ebook"),s.createElement("span",null,"Amount"),s.createElement("span",null,"Commission"),s.createElement("span",null,"Date")),c.map(L=>s.createElement("div",{key:L.id,className:I.referralRow},s.createElement("span",{className:I.referralCell},s.createElement("span",{className:I.referralCellLabel},"Customer:"),L.customer),s.createElement("span",{className:I.referralCell},s.createElement("span",{className:I.referralCellLabel},"Ebook:"),L.ebook),s.createElement("span",{className:I.referralCell},s.createElement("span",{className:I.referralCellLabel},"Amount:"),L.amount),s.createElement("span",{className:I.referralCell},s.createElement("span",{className:I.referralCellLabel},"Commission:"),s.createElement("span",{className:I.commissionAmount},L.commission)),s.createElement("span",{className:I.referralCell},s.createElement("span",{className:I.referralCellLabel},"Date:"),ae(L.date)))))),t==="payouts"&&s.createElement("div",{className:I.payouts},s.createElement("h2",{className:I.tabTitle},"Payout Settings"),s.createElement("div",{className:I.payoutsGrid},s.createElement("div",{className:I.bankDetailsCard},s.createElement("h3",{className:I.cardTitle},"Bank Details"),k?s.createElement("div",{className:I.bankDetails},s.createElement("div",{className:I.bankDetail},s.createElement("span",{className:I.bankDetailLabel},"Account Number:"),s.createElement("span",{className:I.bankDetailValue},S.accountNumber)),s.createElement("div",{className:I.bankDetail},s.createElement("span",{className:I.bankDetailLabel},"Account Name:"),s.createElement("span",{className:I.bankDetailValue},S.accountName)),s.createElement("div",{className:I.bankDetail},s.createElement("span",{className:I.bankDetailLabel},"Bank:"),s.createElement("span",{className:I.bankDetailValue},S.bankName)),s.createElement("button",{onClick:()=>E(!1),className:I.editButton},"Edit Details")):s.createElement("div",{className:I.bankForm},s.createElement("div",{className:I.formGroup},s.createElement("label",null,"Account Number"),s.createElement("input",{type:"text",value:S.accountNumber,onChange:L=>y({...S,accountNumber:L.target.value}),placeholder:"10-digit account number",maxLength:"10"})),s.createElement("div",{className:I.formGroup},s.createElement("label",null,"Account Name"),s.createElement("input",{type:"text",value:S.accountName,onChange:L=>y({...S,accountName:L.target.value}),placeholder:"Full account name"})),s.createElement("div",{className:I.formGroup},s.createElement("label",null,"Bank Code"),s.createElement("input",{type:"text",value:S.bankCode,onChange:L=>y({...S,bankCode:L.target.value}),placeholder:"e.g., 058 for GTBank"})),s.createElement("div",{className:I.formGroup},s.createElement("label",null,"Bank Name"),s.createElement("input",{type:"text",value:S.bankName,onChange:L=>y({...S,bankName:L.target.value}),placeholder:"e.g., GTBank"})),s.createElement("button",{onClick:ne,className:I.saveButton,disabled:a},a?"Saving...":"Save Bank Details"))),s.createElement("div",{className:I.payoutCard},s.createElement("h3",{className:I.cardTitle},"Request Payout"),s.createElement("div",{className:I.earningsSummary},s.createElement("div",{className:I.earningRow},s.createElement("span",null,"Pending Earnings:"),s.createElement("span",{className:I.earningAmount},(($=r==null?void 0:r.earnings)==null?void 0:$.formattedPending)||"₦0")),s.createElement("div",{className:I.earningRow},s.createElement("span",null,"Minimum Payout:"),s.createElement("span",{className:I.earningAmount},((H=r==null?void 0:r.payout)==null?void 0:H.formattedThreshold)||"₦5,000"))),k?s.createElement("div",{className:I.payoutForm},s.createElement("div",{className:I.formGroup},s.createElement("label",null,"Amount to Withdraw (₦)"),s.createElement("input",{type:"number",value:C,onChange:L=>A(L.target.value),placeholder:"Enter amount",min:(oe=r==null?void 0:r.payout)!=null&&oe.threshold?r.payout.threshold/100:50,max:(fe=l==null?void 0:l.pending)!=null&&fe.amount?l.pending.amount/100:0})),s.createElement("button",{onClick:we,className:I.payoutButton,disabled:a||!C||parseFloat(C)<((We=r==null?void 0:r.payout)!=null&&We.threshold?r.payout.threshold/100:50)},a?"Processing...":"Request Payout"),s.createElement("p",{className:I.payoutNote},"Payouts are processed within 7 business days")):s.createElement("div",{className:I.bankRequired},s.createElement("p",null,"Please add your bank details first to request payouts.")))))),f&&s.createElement("div",{className:I.modalOverlay},s.createElement("div",{className:I.modal},s.createElement("div",{className:I.modalHeader},s.createElement("h3",{className:I.modalTitle},"Create New Campaign"),s.createElement("button",{onClick:()=>h(!1),className:I.modalClose},s.createElement(W,{name:"X"}))),s.createElement("div",{className:I.modalBody},s.createElement("div",{className:I.formGroup},s.createElement("label",null,"Campaign Name *"),s.createElement("input",{type:"text",value:p.name,onChange:L=>N({...p,name:L.target.value}),placeholder:"e.g., Twitter Promo, WhatsApp Status"})),s.createElement("div",{className:I.formGroup},s.createElement("label",null,"Description (Optional)"),s.createElement("textarea",{value:p.description,onChange:L=>N({...p,description:L.target.value}),placeholder:"Describe your campaign",rows:"3"})),s.createElement("div",{className:I.formRow},s.createElement("div",{className:I.formGroup},s.createElement("label",null,"Medium (Optional)"),s.createElement("input",{type:"text",value:p.medium,onChange:L=>N({...p,medium:L.target.value}),placeholder:"e.g., social, email"})),s.createElement("div",{className:I.formGroup},s.createElement("label",null,"Source (Optional)"),s.createElement("input",{type:"text",value:p.source,onChange:L=>N({...p,source:L.target.value}),placeholder:"e.g., twitter, facebook"})))),s.createElement("div",{className:I.modalFooter},s.createElement("button",{onClick:()=>h(!1),className:I.cancelButton},"Cancel"),s.createElement("button",{onClick:Z,className:I.createButton,disabled:a||!p.name},a?"Creating...":"Create Campaign")))))};function SS(){const[e,t]=b.useState(!1),n=()=>{t(!0)},a=()=>{t(!1)};return s.createElement(Cg,null,s.createElement(yn,{path:"/",element:s.createElement(lb,{onPurchase:n,purchaseComplete:e})}),s.createElement(yn,{path:"/thank-you",element:s.createElement(RE,{onBackToHome:a,purchaseComplete:e})}),s.createElement(yn,{path:"*",element:s.createElement(_g,{to:"/"})}),s.createElement(yn,{path:"/read/:ebookId",element:s.createElement(FE,null)}),s.createElement(yn,{path:"/affiliate/token/:token",element:s.createElement(jE,null)}),s.createElement(yn,{path:"/affiliate/dashboard",element:s.createElement(ES,null)}))}const _S=Ss.createRoot(document.getElementById("root"));_S.render(s.createElement(s.StrictMode,null,s.createElement(Pg,null,s.createElement(SS,null))));
