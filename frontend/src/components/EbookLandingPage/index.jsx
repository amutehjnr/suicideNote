...
const EbookLandingPage = () => {
  ...
  // ── BLANK LANDING PAGE ──────────────────────────────────────────────────────
  // All state, handlers, and the GuestCheckoutModal are preserved so that
  // payment / access-code / affiliate flows continue to work correctly.
  // Replace the content below whenever you are ready to design the page.
  return (
    <div>
      {/* GuestCheckoutModal must stay mounted so the purchase flow works */}
      <GuestCheckoutModal
        isOpen={showGuestCheckout}
        onClose={() => setShowGuestCheckout(false)}
        onSuccess={handleGuestCheckoutSuccess}
