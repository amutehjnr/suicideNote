// Book content data - Complete version with all chapters
...
All rights reserved.`,
  ...
  {
    page: 2,
    chapter: "Important Mental Health Notice",
...
A Note from the Author`,
  ...
  {
    page: 5,
    chapter: "Chapter One: The Note Begins",
    content: `CHAPTER ONE
The Note Begins
...
I clock in at 7 AM. Mr. Chen, my manager, barely looks up from his clipboard. I don't think he knows my full name. He calls me "You" or "Hey" or sometimes just points. The warehouse is concrete floors and fluorescent lights that make these annoying buzz sounds. Metal shelves stretch up to the ceiling, rows and rows of boxes with codes I've memorized without meaning to: 3847B, rechargeable fans. 4729C, phone chargers. 6012A, plastic basins.`,
  ...
  },
  {
    page: 8,
    chapter: "Chapter One: The Note Begins (Continued)",
    content: `I scan items. I record numbers in the computer. I stack boxes. I move to the next section. The beep of the scanner becomes the only rhythm in my day.
...
At 4 PM, I clock out. Two hours back to Ojuelegba. By the time I get home, it's past six and I'm so tired I can feel it in my bones. Not tired from physical work—the warehouse isn't hard labor, just mindless repetition. Tired from existing. Tired from pretending I'm fine when Mr. Chen yells about working faster. Tired from sitting in traffic watching the sun set behind buildings I'll never afford to live in. Tired from being invisible.`,
  ...
  },
  {
    page: 9,
    chapter: "Chapter One: The Note Begins (Continued)",
    content: `I eat—usually bread and eggs or indomie if I'm too drained to cook—and then I open my laptop.
...
I upgrade my barracks. I collect resources. I watch the timer count down—six hours until my barbarian king is done upgrading, twelve hours until I can use my army again. I check the app obsessively, even at work, because there's always something to do, some progress to track. I can measure my life in these small victories: archer tower to level 13, clan castle to level 6, war stars earned.`,
  ...
  },
  {
    page: 10,
    chapter: "Chapter One: The Note Begins (Continued)",
    content: `But when I close the app, nothing has changed. My room is still small. My bank account is still nearly empty. I'm still twenty-six with a business degree and a job that doesn't require one. The progress isn't real. It's pixels on a screen. And I know this, but I keep playing because at least it's something.
...
I fall asleep with my laptop still playing, voices in a language I don't always understand filling the silence so I don't have to hear how alone I am.`,
  ...
  },
  {
    page: 11,
    chapter: "Chapter One: The Note Begins (Continued)",
    content: `At night, after the films end or I've finally closed Clash of Clans, there's the other thing. The thing I don't want to write about but should, because this is supposed to be honest.
...
This is every night. This has been every night for longer than I can remember.`,
    wordCount: 280
  },
  {
    page: 12,
    chapter: "Chapter One: The Note Begins (Continued)",
    content: `My mother calls on Sundays. Every Sunday after church, between 2 and 3 PM—she teaches at a primary school in Surulere, so Sundays are her time to check on everyone—my phone rings with "Mummy Calling" on the screen. I let it go to voicemail, then text: "Sorry, busy. Will call later."
...
But I didn't say that. I said, "Sorry, sir. I'll work faster."`,
    wordCount: 210
  },
  {
    page: 15,
    chapter: "Chapter One: The Note Begins (Continued)",
    content: `He waved his hand like I was a fly. "You always sorry. Sorry doesn't finish the job. Faster, or we find someone else."
...
That's when I took out this notebook.`,
    wordCount: 240
  },
  {
    page: 16,
    chapter: "Chapter One: The Note Begins (Continued)",
    content: `I've been thinking about this for weeks. Months, maybe. Not in a dramatic way—no sudden decision, no breaking point. Just a quiet certainty that's been building like dust in a room no one cleans. One day you notice it's everywhere, and you realize it's been accumulating all along.
...
The world would close over the space I left like water over a stone. In six months, maybe a year, I'd just be a sad story they occasionally remember: "Remember Eli? So sad. He was always so quiet."`,
    wordCount: 340
  },
  {
    page: 17,
    chapter: "Chapter One: The Note Begins (Continued)",
    content: `That's the truth, isn't it? I'm already gone. I've been gone for years. This would just make it official.
...
Some people aren't meant for this. Some people don't have what it takes. I think I'm one of them.`,
    wordCount: 290
  },
  {
    page: 18,
    chapter: "Chapter One: The Note Begins (Continued)",
    content: `My phone battery is at 11% now. The light is dimming. I should finish this.
...
Or maybe it's that the note is finished—the words are written, the explanation is done—and I don't have to carry it in my head anymore. It's on paper now. It exists outside of me. And somehow that makes it less urgent.`,
    wordCount: 310
  },
  {
    page: 20,
    chapter: "Chapter One: The Note Begins (Continued)",
    content: `I don't destroy the note. I don't change my mind, not really. But I don't get up and do it either.
...
Almost.`,
  ...
  {
    page: 21,
    chapter: "Chapter Two: The Days After",
    content: `CHAPTER TWO
The Days After
...
I don't know what to do with this information.`,
  ...
  {
    page: 22,
    chapter: "Chapter Two: The Days After (Continued)",
    content: `I get up because my bladder demands it. Walk to the shared bathroom down the corridor, past other tenants' doors—Mama Tunde's, Brother Segun's, the young couple whose names I never learned. The bathroom is empty, thankfully. I pee, wash my face with the brown water that comes from the tap, avoid looking at myself in the cracked mirror.
...
Then I lie back down on my bed and stare at the ceiling.`,
    wordCount: 260
  },
  {
    page: 23,
    chapter: "Chapter Two: The Days After (Continued)",
    content: `The day stretches ahead. Empty. Purposeless. What do people do on Saturdays?
...
But I don't. Because then she'll ask questions. She'll hear something in my voice. She'll know something is wrong. And I don't have the energy to lie convincingly.`,
    wordCount: 210
  },
  {
    page: 24,
    chapter: "Chapter Two: The Days After (Continued)",
    content: `I scroll through my phone instead. Instagram. Everyone's Saturday is better than mine. Kunle at a beach in Lekki with colleagues from the bank. Femi's Instagram story showing his UK university campus, autumn leaves, caption: "Loving this weather ♣️." Tosin posted photos of his wife and daughter—the daughter is maybe six months now, I've lost track.
...
Eventually I force myself to play. Run a few attacks. Win some loot. Upgrade a cannon. Go through the motions because it's something to do. Because the alternative is lying here thinking about the note in the wardrobe and why I'm still alive when I planned not to be.`,
    wordCount: 210
  },
  {
    page: 25,
    chapter: "Chapter Two: The Days After (Continued)",
    content: `Around noon, I hear sounds outside my window. Children playing in the compound. Someone's radio blasting gospel music—one of those energetic Pentecostal songs about victory and breakthrough. A woman's voice calling out: "Tunde! Tunde, come and eat!"
...
When I'm done, I wash the pot in the bucket of water by the door—NEPA hasn't brought light yet today, so the electric pump isn't working. I'll need to fetch water from the compound tap later. Add it to the list of things I should do but probably won't.`,
    wordCount: 320
  },
  {
    page: 26,
    chapter: "Chapter Two: The Days After (Continued)",
    content: `I lie back down.
...
I get up slowly, open the door only a fraction. "Good evening, ma."`,
    wordCount: 240
  },
  {
    page: 27,
    chapter: "Chapter Two: The Days After (Continued)",
    content: `Iya Alaje is standing there in her wrapper and buba, headscarf tied tight, fanning herself with a small handheld fan. She looks at me with those knowing eyes that have seen sixty-something years of people and their problems.
...
She walks away, and I close the door.`,
  ...
  },
  {
    page: 28,
    chapter: "Chapter Two: The Days After (Continued)",
    content: `I stand there for a moment, her words echoing. Life too hard to carry alone.
...
For what? I don't know anymore.`,
  ...
  },
  {
    page: 29,
    chapter: "Chapter Two: The Days After (Continued)",
    content: `I close Instagram. Stare at my home screen. My wallpaper is the default—some generic nature photo that came with the phone. I never bothered to change it. Why would I? It's just a phone. Just a screen I look at while my life doesn't happen.
...
Maybe that has to be enough.`,
  ...
  },
  {
    page: 30,
    chapter: "Chapter Two: The Days After (Continued)",
    content: `I don't remember falling asleep, but I must have because suddenly it's dark outside and my phone says 11:34 PM. The fan is still spinning. The light is still on. I'm still in my work clothes from Friday, now two days old, smelling of sweat and warehouse and giving up.
...
For better or worse, I'm still here.`,
  ...
  {
    page: 31,
    chapter: "Chapter Three: One More Chance",
...
"Hello, Mummy."`,
  ...
  {
    page: 32,
    chapter: "Chapter Three: One More Chance (Continued)",
    content: `There's a surprised pause. Like she didn't actually expect me to pick up.
...
"I'm just tired, Mummy. Work stress. That's all."`,
    wordCount: 270
  },
  {
    page: 33,
    chapter: "Chapter Three: One More Chance (Continued)",
    content: `She's quiet for a moment. I can hear sounds in the background—Daddy's voice asking something, probably "Is that Eli?", other people talking, maybe Tola and her family visiting.
...
And he's gone. Handed the phone back to Mummy. That's the extent of our conversation. How is work. Good. Take care.`,
    wordCount: 210
  },
  {
    page: 34,
    chapter: "Chapter Three: One More Chance (Continued)",
    content: `Mummy comes back on: "Eli mi, I love you. You know that?"
...
What changed? Why am I here?`,
    wordCount: 270
  },
  {
    page: 35,
    chapter: "Chapter Three: One More Chance (Continued)",
    content: `I don't have an answer. Just exhaustion. Just the thought: One more day. Tomorrow I'll see.
...
The admins accept me within five minutes. Suddenly I'm in.`,
    wordCount: 300
  },
  {
    page: 36,
    chapter: "Chapter Three: One More Chance (Continued)",
    content: `I scroll through the posts. My heart is pounding, but I keep reading.
...
They're here. And they're talking. And they're not being judged.`,
    wordCount: 300
  },
  {
    page: 37,
    chapter: "Chapter Three: One More Chance (Continued)",
    content: `I spend two hours reading. I don't post anything. Just lurk. Learn.
...
I watch the comments accumulate. Watch strangers hold this person up with words. With presence. With the simple act of responding.`,
    wordCount: 320
  },
  {
    page: 38,
    chapter: "Chapter Three: One More Chance (Continued)",
    content: `My fingers hover over the keyboard.
...
Tomorrow, I'll see.`,
  ...
  {
    page: 39,
    chapter: "Chapter Four: Strangers Who Understand",
...
I scan items. 3847B. 4729C. 6012A. Beep. Record. Stack. Move to the next. The rhythm of my life. The soundtrack of my existence.`,
    wordCount: 350
  },
  {
    page: 40,
    chapter: "Chapter Four: Strangers Who Understand (Continued)",
    content: `At 9 AM, Ibrahim appears with his usual greeting. "Bros! How far? How was your weekend?"
...
I said yes.`,
  ...
  },
  {
    page: 41,
    chapter: "Chapter Four: Strangers Who Understand (Continued)",
    content: `At 1 PM, Ibrahim finds me. "Bros! Time to chop!"
...
But it's not that simple. Is it?`,
  ...
  },
  {
    page: 42,
    chapter: "Chapter Four: Strangers Who Understand (Continued)",
    content: `We finish eating. Ibrahim insists on paying even though I offer. "I tell you say na my treat. Next time you fit pay."
...
I spend the next hour reading. Learning the rhythms of the community. Who posts when. Who responds to what. The inside jokes. The recurring themes.`,
    wordCount: 320
  },
  {
    page: 43,
    chapter: "Chapter Four: Strangers Who Understand (Continued)",
    content: `Someone posts: "Day 47 of therapy. Today my therapist asked what I do for fun and I realized I don't remember what fun is. So that was depressing."
...
And now maybe they're keeping her alive too.`,
    wordCount: 430
  },
  {
    page: 44,
    chapter: "Chapter Four: Strangers Who Understand (Continued)",
    content: `Then a private message pops up. From someone named Chidinma Okafor.
...
But it's close.`,
  ...
  {
    page: 45,
    chapter: "Chapter Five: The Facebook Confession",
...
I sit because refusing would be rude. She sits beside me, fanning herself with a paper plate.`,
    wordCount: 380
  },
  {
    page: 48,
    chapter: "Chapter Five: The Facebook Confession (Continued)",
    content: `"So Eli, where you from?"
...
"Anytime. Anytime you wan come, just tell me. We dey do this every month."`,
    wordCount: 390
  },
  {
    page: 49,
    chapter: "Chapter Five: The Facebook Confession (Continued)",
    content: `On the danfo ride home, I think about what Mama Grace said. Presence is what matters.
...
"Good. Keep trying."`,
  ...
  },
  {
    page: 50,
    chapter: "Chapter Five: The Facebook Confession (Continued)",
    content: `That night, I start reading the book. Just a few pages. Then a few more. Then I can't stop.
...
I read her message three times. Maybe we just get better at doing hard things.`,
    wordCount: 280
  },
  {
    page: 51,
    chapter: "Chapter Five: The Facebook Confession (Continued)",
    content: `Sunday comes. I dress in proper clothes—not work clothes, not stay-at-home clothes, but actual going-somewhere clothes. I take a danfo to Surulere, nervous the entire way.
...
"I promise."`,
  ...
  },
  {
    page: 52,
    chapter: "Chapter Five: The Facebook Confession (Continued)",
    content: `On the danfo ride back to Ojuelegba, I feel exhausted. Social interaction always exhausts me. But it's different from the bone-deep exhaustion of depression.
...
It's a start, and for now, this is enough.`,
    wordCount: 350
  },
  {
    page: 53,
    chapter: "Chapter Six: Learning to Reach",
    content: `CHAPTER SIX
Learning to Reach
...
"That's all I'm asking. Just try."`,
  ...
  {
    page: 54,
    chapter: "Chapter Six: Learning to Reach (Continued)",
    content: `I tell Ibrahim about it at lunch the next day.
...
"I hear."`,
  ...
  },
  {
    page: 55,
    chapter: "Chapter Six: Learning to Reach (Continued)",
    content: `Saturday arrives with the weight of inevitability.
...
And she's real. And I'm real. And we're both here.`,
    wordCount: 480
  },
  {
    page: 56,
    chapter: "Chapter Six: Learning to Reach (Continued)",
    content: `"You want coffee?" she asks. "I'm buying. You came all the way from Ojuelegba—that's a journey."
...
"Thank you," I manage. "For being here. All of you."`,
    wordCount: 450
  },
  {
    page: 57,
    chapter: "Chapter Six: Learning to Reach (Continued)",
    content: `We talk for two hours. About Lagos, about mental health, about the absurdity of Nigerian families who think depression is a "white people problem." About medication, therapy, coping mechanisms. About bad days and good days and the days in between.
...
Dinma is real. Not just a profile picture or words on a screen. A person. With braids and glasses and a laugh that makes me want to make her laugh again.`,
    wordCount: 500
  },
  {
    page: 58,
    chapter: "Chapter Six: Learning to Reach (Continued)",
    content: `I message the group when I get home:
...
And for the first time in years, looking forward doesn't feel impossible.`,
    wordCount: 390
  },
  {
    page: 59,
    chapter: "Chapter Seven: The First Meeting",
...
"You're right," I say. "It does mean something."`,
    wordCount: 340
  },
  {
    page: 60,
    chapter: "Chapter Seven: The First Meeting (Continued)",
    content: `We finish eating and sit there talking. About everything and nothing. She tells me about growing up in Enugu, about moving to Lagos two years ago for work, about how lonely she felt at first.
...
We're quiet for a moment. Around us, Lagos continues—okadas zipping past, hawkers calling out their wares, someone's radio playing Afrobeats too loud. The chaos we've both learned to live with.`,
    wordCount: 210
  },
  {
    page: 61,
    chapter: "Chapter Seven: The First Meeting (Continued)",
    content: `We start meeting every Saturday after that.
...
"Start with what you see every day. The danfo rides. The compound. The warehouse. Document your life. See what happens."`,
    wordCount: 300
  },
  {
    page: 62,
    chapter: "Chapter Seven: The First Meeting (Continued)",
    content: `So I start taking photos. Really taking them, not just random snapshots.
...
Maybe photography could be that. Not a career—I'm realistic. But something. A reason to pay attention. A reason to notice beauty in places I'd normally see only emptiness.`,
    wordCount: 300
  },
  {
    page: 63,
    chapter: "Chapter Seven: The First Meeting (Continued)",
    content: `It's mid-March when things shift between us.
...
And I feel something I haven't felt in years: hope. Not the fragile, tentative hope of "maybe I won't die today." Real hope. The kind that imagines a future. Dinma in my future. Possibilities in my future.`,
    wordCount: 430
  },
  {
    page: 64,
    chapter: "Chapter Seven: The First Meeting (Continued)",
    content: `That night, I message the Facebook group:
...
But everything has changed.`,
  ...
  },
  {
    page: 65,
    chapter: "Chapter Seven: The First Meeting (Continued)",
    content: `Dinma and I become official in late March. We don't make a big announcement. Just start calling each other boyfriend and girlfriend. Start planning our weeks around each other. Start thinking in terms of "we" instead of just "I."
...
"It's worth everything," I say.`,
    wordCount: 260
  },
  {
    page: 66,
    chapter: "Chapter Seven: The First Meeting (Continued)",
    content: `In April, I finally made the appointment with the therapist Seun recommended.
...
And showing up was everything.`,
    wordCount: 350
  },
  {
    page: 67,
    chapter: "Chapter Eight: Something Worth Fighting For",
...
"Eli," she says firmly. "It IS a big deal. Six months ago, you were playing Clash of Clans and feeling like your life meant nothing. Now you're being exhibited. That's growth. That's proof you're creating something real."`,
    wordCount: 210
  },
  {
    page: 68,
    chapter: "Chapter Eight: Something Worth Fighting For (Continued)",
    content: `The exhibition opening is terrifying.
...
No one sees it. I have zero followers. But it exists.`,
    wordCount: 260
  },
  {
    page: 69,
    chapter: "Chapter Eight: Something Worth Fighting For (Continued)",
    content: `Later that night, I'm lying in bed, unable to sleep. Not from anxiety. From something else. Something I can't quite name.
...
I close my eyes, Dinma's warmth beside me, and for the first time in years, I fall asleep not just grateful to have survived the day, but actually looking forward to tomorrow.`,
    wordCount: 430
  },
  {
    page: 70,
    chapter: "Chapter Nine: Years Later",
    content: `CHAPTER NINE
Years Later
...
Room to grow.`,
  ...
  {
    page: 71,
    chapter: "Chapter Nine: Years Later (Continued)",
    content: `"You nervous about the move?" she asks.
...
"Exactly. Look at you now."`,
    wordCount: 250
  },
  {
    page: 72,
    chapter: "Chapter Nine: Years Later (Continued)",
    content: `The movers arrive at 10 AM. Two guys with a small truck. We don't have much furniture—most of it came with the flat. Just our personal stuff. Books. Clothes. My camera equipment. Dinma's tech setup. Kitchen things we've accumulated.
...
She waits. Doesn't push. Just sits with me.`,
    wordCount: 310
  },
  {
    page: 73,
    chapter: "Chapter Nine: Years Later (Continued)",
    content: `I turn the page. After the suicide note, there are other entries. Dated. Written over months in late 2024 and early 2025.
...
We pack the notebook carefully in a box labeled "Personal - Eli." With my other important things—old LASU documents, family photos, the program from my first real photography exhibition two years ago, the business cards from my freelance work.`,
    wordCount: 470
  },
  {
    page: 74,
    chapter: "Chapter Nine: Years Later (Continued)",
    content: `The movers load everything onto the truck. We do a final walk-through of the flat—making sure we got everything, making sure we're leaving it clean for the next tenants.
...
"Yeah," I say. "I like that."`,
    wordCount: 270
  },
  {
    page: 75,
    chapter: "Chapter Nine: Years Later (Continued)",
    content: `Later that night, after we've set up our bedroom, after we've showered and changed and collapsed into bed exhausted, I lie there unable to sleep.
...
For having chosen, again and again, to stay.`,
    wordCount: 460
  },
  {
    page: 76,
    chapter: "Chapter Ten: What Was Always There",
    content: `CHAPTER TEN
...
"This," I say. "What I have. It's enough."`,
    wordCount: 470
  },
  {
    page: 77,
    chapter: "Chapter Ten: What Was Always There (Continued)",
    content: `After breakfast, we decide to explore the neighborhood. We've lived in Yaba for two years, but this street is new to us. Different shops, different faces, different rhythms.
...
"Yeah. I can."`,
  ...
  },
  {
    page: 78,
    chapter: "Chapter Ten: What Was Always There (Continued)",
    content: `That evening, we host a small gathering at the new place. Not a housewarming exactly—we haven't unpacked enough for that. Just a few people coming by to see the new spot.
...
The choice to stay. To try. To reach. To see.`,
    wordCount: 430
  },
  {
    page: 79,
    chapter: "Chapter Ten: What Was Always There (Continued)",
    content: `My name is Eliora Oluwafemi Adetayo.
...
And I'm so, so glad I did.`,
  ...
  {
    page: 80,
    chapter: "Crisis Support Resources",
    content: `Crisis Support Resources (Nigeria)
...
If you are outside Nigeria, please contact your local emergency number or a suicide prevention hotline in your country.`,
    wordCount: 90
  },
  {
    page: 81,
...
export const totalWords = BOOK_CONTENT.reduce((sum, page) => sum + (page.wordCount || 0), 0);
export const totalPages = BOOK_CONTENT.length;
export const readingTimeMinutes = Math.ceil(totalWords / 200);

// Get unique chapters for navigation
export const getUniqueChapters = () => {
  const seen = new Set();
